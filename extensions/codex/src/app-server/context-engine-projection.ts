/**
 * Projects Natesclaw context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "natesclaw/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "Natesclaw assembled context for this turn:";
...
/** Projects assembled Natesclaw context-engine messages into Codex prompt inputs. */
