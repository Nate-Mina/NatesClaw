...
type NatesclawBoardWidgetCell = HTMLElementTagNameMap["natesclaw-board-widget-cell"];
...
export async function settleCells(view: NatesclawBoardView): Promise<NatesclawBoardWidgetCell[]> {
