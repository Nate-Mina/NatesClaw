...
class NatesclawImageLightbox extends NatesclawLitElement {
  @property() src = "";
  ...
  static override styles = css`
    ...
    natesclaw-modal-dialog {
      --natesclaw-modal-width: min(1280px, calc(100vw - 40px));
      --natesclaw-modal-max-width: calc(100vw - 40px);
      --natesclaw-modal-max-height: calc(100dvh - 40px);
    }
    ...
    @media (max-width: 720px), (max-height: 520px) and (orientation: landscape) {
      natesclaw-modal-dialog {
        --natesclaw-modal-width: calc(100vw - 24px);
        --natesclaw-modal-max-width: calc(100vw - 24px);
        --natesclaw-modal-max-height: 100dvh;
      }
...
if (!customElements.get("natesclaw-image-lightbox")) {
  customElements.define("natesclaw-image-lightbox", NatesclawImageLightbox);
}

declare global {
  interface HTMLElementTagNameMap {
    "natesclaw-image-lightbox": NatesclawImageLightbox;
  }
}
