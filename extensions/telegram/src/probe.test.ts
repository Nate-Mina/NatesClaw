...
vi.mock("natesclaw/plugin-sdk/response-limit-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("natesclaw/plugin-sdk/response-limit-runtime")>();
  return {
    ...actual,
