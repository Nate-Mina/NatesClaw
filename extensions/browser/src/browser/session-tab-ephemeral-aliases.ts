...
const volatileAliasStateSymbol = Symbol.for("natesclaw.browser.session-tabs.volatile-aliases");
const volatileExactStateSymbol = Symbol.for("natesclaw.browser.session-tabs.exact-volatile-aliases");
