...
function registerCommands(): NatesclawPluginCommandDefinition[] {
  ensurePlatformAdapter();
  const commands: NatesclawPluginCommandDefinition[] = [];
  const api = {
    logger: {},
    registerCommand: (command: NatesclawPluginCommandDefinition) => {
...
function findCommand(
  commands: NatesclawPluginCommandDefinition[],
  name: string,
): NatesclawPluginCommandDefinition {
