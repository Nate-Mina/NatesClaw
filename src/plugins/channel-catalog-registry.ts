...
import { normalizeOptionalString as resolveOptionalString } from "@natesclaw/normalization-core/string-coerce";
...
function resolveChannelCatalogDiscoveryScopeKey(params: ChannelCatalogParams): string {
  ...
  return JSON.stringify({
    ...
    bundledSourceOverlaysDisabled: env.NATESCLAW_DISABLE_BUNDLED_SOURCE_OVERLAYS ?? "",
