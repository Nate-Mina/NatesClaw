...
type WebFetchConfig = NonNullable<NatesclawConfig["tools"]>["web"] extends infer Web
...
let webFetchProviderCache = new WeakMap<NatesclawConfig, WebFetchProviderCacheEntry>();
...
function resolveFetchConfig(config: NatesclawConfig | undefined): WebFetchConfig | undefined {
...
function createWebFetchProviderConfigFingerprint(config: NatesclawConfig): string {
