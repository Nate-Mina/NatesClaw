// Natesclaw runtime test setup installs runtime mocks and cleanup.
...
const WORKER_RUNTIME_STATE = Symbol.for("natesclaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("natesclaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("natesclaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: NatesclawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
