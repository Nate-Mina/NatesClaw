...
function mergeZalouserAccountConfig(cfg: NatesclawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: NatesclawConfig; accountId?: string | null }) {
