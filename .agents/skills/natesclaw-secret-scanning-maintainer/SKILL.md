---
name: natesclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Natesclaw GitHub Secret Scanning alerts in issues or PRs.
---

# Natesclaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/natesclaw/natesclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/natesclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/natesclaw/natesclaw/issues/63101#issuecomment-xxx",
