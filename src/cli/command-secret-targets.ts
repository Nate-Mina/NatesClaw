...
function resolveFetchConfig(config: NatesclawConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: NatesclawConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: NatesclawConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: NatesclawConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "natesclaw.json" &&
 ...
 */
export function getAgentRuntimeOptionalCommandSecretPaths(config: NatesclawConfig): Set<string> {
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: NatesclawConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: NatesclawConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
