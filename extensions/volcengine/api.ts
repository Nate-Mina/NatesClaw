...
import { applyModelCompatPatch } from "natesclaw/plugin-sdk/provider-model-shared";
import type { ModelCompatConfig } from "natesclaw/plugin-sdk/provider-model-shared";
