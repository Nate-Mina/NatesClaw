...
// Natesclaw operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Natesclaw itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Natesclaw navigated to a blocked URL. */
