...
struct ConnectOptions {
    ...
    var clientId: String = "natesclaw-macos"
...
func runConnect(_ args: [String]) async {
    ...
    if opts.help {
        ...
        Options:
          ...
          --json             Emit JSON
          --client-id <id>   Override client id (default: natesclaw-macos)
    ...
    do {
        ...
        let displayName = opts.displayName ?? Host.current().localizedName ?? "Natesclaw macOS Debug CLI"
...
private func printConnectOutput(_ output: ConnectOutput, json: Bool) {
    ...
    print("Natesclaw macOS Gateway Connect")
...
func gatewayURLDeviceAuthOwner(_ url: URL, mode: String) -> String {
    ...
    return "natesclaw-mac-cli:route:\(fingerprint)"
}
