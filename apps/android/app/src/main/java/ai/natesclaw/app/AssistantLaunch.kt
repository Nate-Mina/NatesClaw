...
const val actionAskNatesclaw = "ai.natesclaw.app.action.ASK_NATESCLAW"

/** Debug action that opens the Voice tab directly for Android E2E automation. */
const val actionOpenVoiceE2e = "ai.natesclaw.app.debug.OPEN_VOICE_E2E"
...
private fun sharedAttachments(
  ...
  // prevents an external intent from turning Natesclaw into a reader for its own private files.
  val validUris =
    (streamUris + clipUris)
