...
function resolveDefaultStoreAgentId(cfg: NatesclawConfig): string {
...
export function resolveSessionStoreAgentId(cfg: NatesclawConfig, canonicalKey: string): string {
