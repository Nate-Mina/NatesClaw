...
const providerFilter = parseCsvFilter(process.env.NATESCLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.NATESCLAW_LIVE_MUSIC_GENERATION_MODELS);
