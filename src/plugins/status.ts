...
import { normalizeNatesclawVersionBase } from "../config/version.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeNatesclawVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeNatesclawVersionBase(plugin.version) ??
    plugin.version
  );
}
