...
function modelConfig(primary: string, models?: Record<string, object>): NatesclawConfig {
  return {
    agents: {
...
describe("resolveSessionModelIdentityRef", () => {
  const resolveLegacyIdentityRef = (cfg: NatesclawConfig, modelProvider?: string) =>
