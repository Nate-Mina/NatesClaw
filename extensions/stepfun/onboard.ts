...
function createStepFunPresetAppliers(params: {
  ...
  return createModelCatalogPresetAppliers<[string]>({
    ...
    resolveParams: (_cfg: NatesclawConfig, baseUrl: string) => {
...
export function applyStepFunStandardConfigCn(cfg: NatesclawConfig): NatesclawConfig {
  return stepFunPresetAppliers.applyConfig(cfg, STEPFUN_STANDARD_CN_BASE_URL);
}

export function applyStepFunStandardConfig(cfg: NatesclawConfig): NatesclawConfig {
  return stepFunPresetAppliers.applyConfig(cfg, STEPFUN_STANDARD_INTL_BASE_URL);
}

export function applyStepFunPlanConfigCn(cfg: NatesclawConfig): NatesclawConfig {
  return stepFunPlanPresetAppliers.applyConfig(cfg, STEPFUN_PLAN_CN_BASE_URL);
}

export function applyStepFunPlanConfig(cfg: NatesclawConfig): NatesclawConfig {
