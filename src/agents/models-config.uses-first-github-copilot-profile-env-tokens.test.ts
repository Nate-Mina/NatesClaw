...
import { planNatesclawModelsJsonWithDeps } from "./models-config.plan.test-support.js";
import type { ProviderConfig } from "./models-config.providers.secrets.js";
import { createProviderAuthResolver } from "./models-config.providers.secrets.js";

type ResolveImplicitProvidersForModelsJson = NonNullable<
  NonNullable<Parameters<typeof planNatesclawModelsJsonWithDeps>[1]>["resolveImplicitProviders"]
>;
