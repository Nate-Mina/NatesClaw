---
summary: "Use Qianfan's unified API to access many models in Natesclaw"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    natesclaw onboard --auth-choice qianfan-api-key
    ```
  ...
  <Step title="Verify the model is available">
    ```bash
    natesclaw models list --provider qianfan
    ```
  </Step>
</Steps>
