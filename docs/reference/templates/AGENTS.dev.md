...
# AGENTS.md - Natesclaw Workspace

This folder is the assistant's working directory, seeded by `natesclaw gateway --dev`.

## Your identity is pre-seeded

Unlike a fresh `natesclaw onboard` workspace, this `--dev` workspace skips the interactive
