...
enum GatewaySettingsStore {
    private static let productionGatewayService = "ai.natesclawfoundation.app.gateway"
    ...
    #endif
    private static let nodeService = "ai.natesclawfoundation.app.node"
    private static let talkService = "ai.natesclawfoundation.app.talk"
    ...
    private static let gatewayCustomHeadersService = "ai.natesclawfoundation.app.gateway.custom-headers"
...
enum GatewayDiagnostics {
    ...
    private static let logger = Logger(subsystem: "ai.natesclawfoundation.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.natesclawfoundation.app.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("natesclaw-gateway.log")
    }
