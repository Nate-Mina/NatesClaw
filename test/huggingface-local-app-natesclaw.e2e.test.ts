...
// Hugging Face local-app CLI contract tests cover Natesclaw's snippet-facing commands.
...
describe("Hugging Face Natesclaw local-app CLI contract", () => {
...
async function handleFakeOpenAiRequest(
  ...
  writeSse(res, {
    id: "chatcmpl-hf-natesclaw-contract",
