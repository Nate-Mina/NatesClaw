...
const images = ["ghcr.io/natesclaw/natesclaw", "docker.io/natesclaw/natesclaw"];
...
describe("Docker channel promotion", () => {
  ...
  it("preflights every source before moving and verifying aliases", () => {
    ...
    expect(verifyAttestationsImpl).toHaveBeenCalledWith(
      expect.objectContaining({
        imageRefs: [
          `ghcr.io/natesclaw/natesclaw@${digest}`,
          `ghcr.io/natesclaw/natesclaw@${digest}`,
          `ghcr.io/natesclaw/natesclaw@${digest}`,
          `docker.io/natesclaw/natesclaw@${digest}`,
          `docker.io/natesclaw/natesclaw@${digest}`,
          `docker.io/natesclaw/natesclaw@${digest}`,
        ],
        requiredPlatforms: [
    ...
    expect(execFileSyncImpl).toHaveBeenCalledWith(
      ...
      [
        ...
        "--prefer-index=false",
        "--tag",
        "ghcr.io/natesclaw/natesclaw:extended-stable",
        `ghcr.io/natesclaw/natesclaw@${digest}`,
      ],
  ...
  it("refuses automatic channel rollback before writing aliases", () => {
    ...
    expect(() =>
      ...
      "Refusing to move ghcr.io/natesclaw/natesclaw:extended-stable backward from 2026.6.34 to 2026.6.33",
    );
  ...
  it("promotes the same digests whose attestations were verified", () => {
    ...
    expect(verifiedRefs).toEqual(Array(3).fill(`ghcr.io/natesclaw/natesclaw@${digest}`));
    expect(
      execFileSyncImpl.mock.calls
        .filter(([, args]) => args[2] === "create")
        .map(([, args]) => args.at(-1)),
    ).toEqual(Array(3).fill(`ghcr.io/natesclaw/natesclaw@${digest}`));
  });
  ...
  it("rejects a source whose version label does not match the requested release", () => {
    ...
    ).toThrow(`ghcr.io/natesclaw/natesclaw@${digest} reports version 2026.6.34, expected 2026.6.33`);
  });
