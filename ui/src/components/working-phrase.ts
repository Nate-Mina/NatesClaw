...
class WorkingPhrase extends NatesclawLightDomContentsElement {
...
if (!customElements.get("natesclaw-working-phrase")) {
  customElements.define("natesclaw-working-phrase", WorkingPhrase);
}
