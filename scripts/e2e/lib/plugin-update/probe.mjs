...
const pluginRecordSnapshot = () => {
  const config = readJson(natesclawPath("natesclaw.json"));
...
function natesclawPath(...parts) {
  return path.join(home, ".natesclaw", ...parts);
}
...
function seedInstallState() {
  writeJson(natesclawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.NATESCLAW_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by Natesclaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("Natesclaw will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "Natesclaw will continue without it",
