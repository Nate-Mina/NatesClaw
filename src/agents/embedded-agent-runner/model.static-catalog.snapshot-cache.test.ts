...
const manifestMocks = vi.hoisted(() => ({
  ...
  listNatesclawPluginManifestMetadata: vi.fn(),
...
vi.mock("../../plugins/manifest-metadata-scan.js", () => ({
  listNatesclawPluginManifestMetadata: manifestMocks.listNatesclawPluginManifestMetadata,
}));
...
function setManifestPlugins(plugins: unknown[]) {
  ...
  manifestMocks.listNatesclawPluginManifestMetadata.mockReturnValue(
  ...
  manifestMocks.loadPluginManifest.mockImplementation((pluginDir: string) => {
    ...
    return plugin
      ...
      : { ok: false, error: "missing manifest", manifestPath: `${pluginDir}/natesclaw.plugin.json` };
  });
}
...
describe("bundled static model catalog snapshot cache", () => {
  it("reuses the current plugin snapshot across separate static model lookups", () => {
    ...
    expect(manifestMocks.listNatesclawPluginManifestMetadata).not.toHaveBeenCalled();
  ...
  it("keeps a custom environment on its own manifest discovery path", () => {
    ...
    expect(manifestMocks.listNatesclawPluginManifestMetadata).toHaveBeenCalledWith(env);
