...
import type { ReplyToMode } from "natesclaw/plugin-sdk/config-contracts";
...
function isSignalAccountEnabled(cfg: NatesclawConfig, config: SignalAccountConfig): boolean {
...
export function listEnabledSignalAccounts(cfg: NatesclawConfig): ResolvedSignalAccount[] {
