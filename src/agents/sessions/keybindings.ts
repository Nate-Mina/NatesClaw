 ...
 *
 * Wraps pi-tui keybindings with Natesclaw-specific actions and per-agent overrides.
 */
...
/** Natesclaw-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads Natesclaw defaults plus optional user overrides. */
