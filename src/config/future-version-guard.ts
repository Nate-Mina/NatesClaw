...
export const ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV =
  "NATESCLAW_ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS";
...
export function resolveFutureConfigActionBlock(
  ...
  return {
    ...
    currentVersion,
    touchedVersion,
    message: `Refusing to ${params.action} because this Natesclaw binary (${currentVersion}) is older than the config last written by Natesclaw ${touchedVersion}.`,
    hints: [
