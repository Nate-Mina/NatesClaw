...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.natesclaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.natesclaw.js").NatesclawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.natesclaw.js").NatesclawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.natesclaw.js").NatesclawConfig>;
    /**
  ...
  media: {
    ...
    detectMime: typeof import("@natesclaw/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@natesclaw/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("natesclaw/plugin-sdk/llm").Model<import("natesclaw/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.natesclaw.js").NatesclawConfig;
      workspaceDir?: string;
