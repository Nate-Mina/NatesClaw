...
function summarizeGroupPolicy(cfg: NatesclawConfig): {
  open: number;
  allowlist: number;
  other: number;
} {
...
function hasWebSearchKey(cfg: NatesclawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebSearchEnabled(cfg: NatesclawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isWebFetchEnabled(cfg: NatesclawConfig): boolean {
...
function isBrowserEnabled(cfg: NatesclawConfig): boolean {
...
export function collectAttackSurfaceSummaryFindings(cfg: NatesclawConfig): SecurityAuditFinding[] {
