...
import type { ModelProviderConfig, NatesclawConfig } from "./types.js";
...
vi.mock("./provider-policy.js", () => ({
  applyProviderConfigDefaultsForConfig: (params: { config: NatesclawConfig }) => params.config,
      ...
      plugins: [
        {
          ...
          source: "test",
          manifestPath: "/tmp/custom-provider-plugin/natesclaw.plugin.json",
