...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "natesclaw-sbx-test",
    runtimeLabel: params.containerName ?? "natesclaw-sbx-test",
    containerName: params.containerName ?? "natesclaw-sbx-test",
