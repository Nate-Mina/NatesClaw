...
show_usage() {
    cat << EOF
clawlog - Natesclaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Natesclaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Natesclaw logs flow through the macOS unified log (subsystem: ai.natesclaw).
