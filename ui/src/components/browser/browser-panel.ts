...
const panelLayout = createDockPanelLayout({
  storageKey: "natesclaw.browser.panel.v1",
  minHeight: 240,
  minWidth: 380,
  defaultDock: "right",
...
/** `<natesclaw-browser-panel>` — the dockable gateway browser surface. */
class NatesclawBrowserPanel extends NatesclawLitElement implements BrowserPanelControllerHost {
...
if (!customElements.get("natesclaw-browser-panel")) {
  customElements.define("natesclaw-browser-panel", NatesclawBrowserPanel);
}

declare global {
  interface HTMLElementTagNameMap {
    "natesclaw-browser-panel": NatesclawBrowserPanel;
  }
}
