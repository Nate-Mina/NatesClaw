...
When the target repo or request is Natesclaw-specific, layer `references/natesclaw.md` on top of these general rules. Otherwise ignore that repo-specific overlay.
