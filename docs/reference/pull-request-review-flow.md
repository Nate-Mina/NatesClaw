---
summary: "How Barnacle and ClawSweeper feedback helps move Natesclaw pull requests through review."
read_when:
...
This page explains the review flow after you open or update an Natesclaw pull
...
ClawSweeper is the AI-assisted review and maintenance bot for Natesclaw
...
Natesclaw also uses separate stale automation. Unassigned issues and PRs can be
