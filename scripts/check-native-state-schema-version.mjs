...
const TYPESCRIPT_CONTRACT_PATH = "src/state/natesclaw-state-db-contract.ts";
...
export function compareNativeStateSchemaVersions({ swiftSource, typescriptSource }) {
  ...
  const typescriptVersion = extractSingleVersion(
    typescriptSource,
    /^export const NATESCLAW_STATE_SCHEMA_VERSION = (\d+);\s*$/gmu,
    "TypeScript NATESCLAW_STATE_SCHEMA_VERSION",
  );
