...
function getChannelConfig(cfg: NatesclawConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: NatesclawConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: NatesclawConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: NatesclawConfig, accountId: string): string[] {
