...
function ensureZalouserPluginEnabled(cfg: NatesclawConfig): NatesclawConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("natesclaw directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("natesclaw directory groups list --channel zalouser"),
            }),
