...
/** Register maintenance commands that inspect or mutate local Natesclaw state. */
export function registerMaintenanceCommands(program: Command) {
  const doctor = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/doctor", "docs.natesclaw.ai/cli/doctor")}\n`,
    )
    ...
    .option(
      "--github-issue",
      "With --session-sqlite recover: prepare and optionally create an natesclaw/natesclaw issue",
      false,
    )
    .option(
      "--json",
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/dashboard", "docs.natesclaw.ai/cli/dashboard")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/reset", "docs.natesclaw.ai/cli/reset")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/uninstall", "docs.natesclaw.ai/cli/uninstall")}\n`,
    )
