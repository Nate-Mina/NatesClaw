...
import { createSubsystemLogger, formatDurationSeconds } from "natesclaw/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("natesclaw/plugin-sdk/runtime-env").createSubsystemLogger
>;
