import type { NatesclawPluginApi, NatesclawPluginService } from "natesclaw/plugin-sdk/plugin-entry";
...
export function registerMxcPlugin(api: NatesclawPluginApi): void {
  ...
  const cleanupService: NatesclawPluginService = {
