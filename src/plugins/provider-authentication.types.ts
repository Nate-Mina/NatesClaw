...
export type ProviderAuthResult = {
   ...
   */
  configPatch?: Partial<NatesclawConfig>;
  defaultModel?: string;
  notes?: string[];
  /**
...
export type ProviderAuthMethod = {
   ...
   * key + OAuth, or region-specific login flows). Natesclaw uses this to expose
...
export type ProviderOAuthProfileIdRepair = {
   ...
   *
   * When omitted, Natesclaw falls back to `<provider>:default`.
   */
