...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(NATESCLAW_PACKAGE_ROOT, "extensions"),
    path.resolve(NATESCLAW_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(NATESCLAW_PACKAGE_ROOT, "dist", "extensions"),
