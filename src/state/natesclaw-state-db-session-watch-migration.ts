...
import { ensureColumn, tableExists, tableHasColumn } from "./natesclaw-state-db-schema-helpers.js";
...
type SessionWatchCursorDatabase = Pick<NatesclawStateKyselyDatabase, "session_watch_cursors">;
