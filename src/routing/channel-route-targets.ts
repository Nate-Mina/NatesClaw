...
function listConfiguredChannelIds(cfg: NatesclawConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: NatesclawConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: NatesclawConfig): ChannelRouteTarget[] {
