  ...
  it(
    ...
    async () => {
      ...
      const result = (await tool.execute({
        objective:
          "Find the Natesclaw GitHub repository and recent project activity for a quick smoke test.",
        search_queries: ["natesclaw github repository", "natesclaw release notes"],
        count: 3,
