...
import { unlinkIfExists } from "natesclaw/plugin-sdk/media-runtime";
import { parseStrictFiniteNumber } from "natesclaw/plugin-sdk/number-runtime";
import {
...
async function generateWaveformFromPcm(filePath: string): Promise<string> {
  const tempDir = resolvePreferredNatesclawTmpDir();
