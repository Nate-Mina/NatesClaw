...
import { buildNatesclawReleaseClawHubRuntimeState } from "./lib/natesclaw-release-clawhub-plan.ts";
...
try {
  const state = buildNatesclawReleaseClawHubRuntimeState(parseArgs(process.argv.slice(2)));
