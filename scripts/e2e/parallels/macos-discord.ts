// Macos Discord script supports Natesclaw repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestNatesclaw: string;
      guestNatesclawEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestNatesclawEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestNatesclawEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestNatesclawEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestNatesclawEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestNatesclawEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestNatesclawEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestNatesclawEntry} gateway restart
${this.input.guestNode} ${this.input.guestNatesclawEntry} channels status --probe --json`);
  }
