...
export function resolveImageFallbackDefaultProvider(cfg: NatesclawConfig | undefined): string {
...
function resolveFallbackCandidateModelProviderCacheParts(cfg: NatesclawConfig | undefined): unknown {
