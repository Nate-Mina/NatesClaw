...
export const PLUGIN_INSTALL_ERROR_CODE = {
  ...
  MISSING_NATESCLAW_EXTENSIONS: "missing_natesclaw_extensions",
  MISSING_PLUGIN_MANIFEST: "missing_plugin_manifest",
  EMPTY_NATESCLAW_EXTENSIONS: "empty_natesclaw_extensions",
  INVALID_NATESCLAW_EXTENSIONS: "invalid_natesclaw_extensions",
