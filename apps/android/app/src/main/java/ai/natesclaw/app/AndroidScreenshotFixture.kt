...
internal object AndroidScreenshotFixture {
  ...
  fun request(
    ...
    when (method) {
      ...
      "cron.runs" -> cronRuns()
      "natesclaw.chat" -> systemAgentChat(paramsJson)
  ...
  private fun systemAgentChat(paramsJson: String?): String {
    ...
    return buildJsonObject {
      put("sessionId", JsonPrimitive("android-screenshot-natesclaw"))
      put(
        "reply",
        JsonPrimitive(
          if (message == null) {
      ...
      if (message == null) {
        put(
          ...
          buildJsonObject {
            ...
            put("header", JsonPrimitive("Natesclaw"))
        ...
        buildJsonArray {
          add(
            buildJsonObject {
              ...
              put("description", JsonPrimitive("Show current Natesclaw status"))
