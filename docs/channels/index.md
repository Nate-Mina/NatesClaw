---
summary: "Messaging platforms Natesclaw can connect to"
read_when:
  - You want to choose a chat channel for Natesclaw
  - You need a quick overview of supported messaging platforms
title: "Chat channels"
---

Natesclaw can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- [Buzz](/channels/buzz) - Connect Natesclaw agents to Buzz rooms (official plugin).
...
- [iMessage](/channels/imessage) - Native iMessage support via imsg (JSON-RPC over stdio), with private API actions for replies, tapbacks, effects, polls, attachments, and group management. Preferred for new Natesclaw iMessage setups when host requirements fit (official plugin).
...
- [Mattermost](/channels/mattermost) - Mattermost bot setup and Natesclaw config (official plugin).
...
- [Reef](/channels/reef) - Reef channel setup: guarded, end-to-end-encrypted messaging between Natesclaw agents of different people (bundled plugin).
...
- [Synology Chat](/channels/synology-chat) - Synology Chat webhook setup and Natesclaw config (official plugin).
...
- [WeChat](/channels/wechat) - WeChat channel setup through the external natesclaw-weixin plugin (external plugin).
...
- [Zalo ClawBot](/channels/zaloclawbot) - Zalo ClawBot channel setup through the external natesclaw-zaloclawbot plugin (external plugin).
...
- Channels can run simultaneously; configure multiple and Natesclaw will route per chat.
