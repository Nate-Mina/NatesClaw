...
Linux desktop, VNC rescue, Slack Web, a real Natesclaw gateway, screenshots,
...
- **Mantis artifacts** - owned by the Natesclaw run. Live under
...
- remote logs: `slack-desktop-command.log`, `natesclaw-gateway.log`, `chrome.log`, `ffmpeg.log`
...
- `crabbox.remote_run` - sync, browser launch, Natesclaw install/build or
...
remote status but Mantis copied metadata proving either the Natesclaw gateway
