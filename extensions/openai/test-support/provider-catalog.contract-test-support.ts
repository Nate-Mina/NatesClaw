...
import type { ProviderPlugin } from "natesclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("natesclaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("natesclaw/plugin-sdk/provider-catalog-runtime")
  >("natesclaw/plugin-sdk/provider-catalog-runtime");
