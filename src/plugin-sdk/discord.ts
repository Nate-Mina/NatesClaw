...
/**
 * @deprecated Compatibility facade for the `natesclaw/plugin-sdk/discord` subpath.
...
export type { NatesclawConfig } from "./config-contracts.js";
export type { NatesclawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in Natesclaw config. */
export type DiscordAccountConfig = NonNullable<NonNullable<NatesclawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: NatesclawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: NatesclawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: NatesclawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: NatesclawConfig }): NatesclawConfig {
...
/** List configured Discord account ids from Natesclaw config. */
export function listDiscordAccountIds(cfg: NatesclawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: NatesclawConfig): string {
