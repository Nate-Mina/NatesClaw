...
import { expectExplicitVideoGenerationCapabilities } from "natesclaw/plugin-sdk/provider-test-contracts";
import { streamedJsonResponse } from "natesclaw/plugin-sdk/test-fixtures";
...
vi.mock("natesclaw/plugin-sdk/provider-http", async (importActual) => {
  const actual = await importActual<typeof import("natesclaw/plugin-sdk/provider-http")>();
  return {
