...
private let dashboardManagerLogger = Logger(subsystem: "ai.natesclaw", category: "DashboardManager")
...
final class DashboardManager {
    ...
    private func autosaveName(for target: DashboardGatewayTarget) -> String {
        ...
        case let .profile(profileID):
            "NatesclawDashboardWindow-\(profileID)"
        }
    }
...
extension DashboardManager {
        ...
        -> DashboardManager
    {
        let manager = DashboardManager(
            ...
            mainWindowAutosaveName: "NatesclawDashboardWindow-Test-\(UUID().uuidString)")
