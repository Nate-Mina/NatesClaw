...
import type { ExecApprovalActionDescriptor } from "natesclaw/plugin-sdk/approval-reply-runtime";
import type {
  DiscordExecApprovalConfig,
  NatesclawConfig,
} from "natesclaw/plugin-sdk/config-contracts";
import { logDebug, logError } from "natesclaw/plugin-sdk/logging-core";
