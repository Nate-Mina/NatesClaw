...
import type { NatesclawExecAsk, NatesclawExecSecurity } from "./config-contracts.js";
import type { CodexServiceTier } from "./protocol.js";

const START_OPTIONS_KEY_SECRET_SYMBOL = Symbol.for("natesclaw.codexAppServerStartOptionsKeySecret");
...
export function readExecSecurity(value: unknown): NatesclawExecSecurity | undefined {
  return value === "deny" || value === "allowlist" || value === "full" ? value : undefined;
}

export function readExecAsk(value: unknown): NatesclawExecAsk | undefined {
