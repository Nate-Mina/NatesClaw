...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<NatesclawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<NatesclawConfig["channels"]>["slack"]>>,
): NatesclawConfig {
  return {
    channels: {
      slack: {
