...
class AppTopbar extends NatesclawLightDomContentsElement {
    ...
    return html`
      ...
      >
        <div class="topnav-shell">
          <natesclaw-tooltip .content=${drawerLabel}>
            <button
              type="button"
          ...
          <div class="topnav-shell__content" @mousedown=${beginNativeWindowDrag}>
            <div class="topbar-brand" aria-label="Natesclaw">
              <img
                ...
                aria-hidden="true"
              />
              <span class="topbar-brand__title">Natesclaw</span>
            </div>
          </div>
          <div class="topnav-shell__actions">
            <natesclaw-tooltip .content=${t("chat.commandPaletteTitle")}>
              <button
                class="topbar-search"
...
if (!customElements.get("natesclaw-app-topbar")) {
  customElements.define("natesclaw-app-topbar", AppTopbar);
}
