...
export function scanDiscordNumericIdEntries(cfg: NatesclawConfig): DiscordNumericIdHit[] {
...
function collectDiscordMutableAllowlistWarnings(cfg: NatesclawConfig): string[] {
