...
export abstract class ChatPaneBase extends NatesclawLightDomElement {
  ...
  @litState() protected sessionRailReady = customElements.get("natesclaw-chat-session-rail") != null;
