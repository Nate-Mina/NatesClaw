...
// Drawn in the smooth Natesclaw lobster style (see the dreams scene and
...
if (!customElements.get("natesclaw-lobster-pet")) {
  customElements.define("natesclaw-lobster-pet", LobsterPet);
}
