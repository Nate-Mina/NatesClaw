...
let dashboardWindowLogger = Logger(subsystem: "ai.natesclaw", category: "DashboardWindow")
...
enum DashboardWindowLayout {
    ...
    static let linkBrowserWidthDefaultsKey = "NatesclawDashboardLinkBrowserWidth"
    static let windowFrameAutosaveName = "NatesclawDashboardWindow"
...
enum DashboardNativeCommand: String {
    case newSession = "natesclaw:native-new-session"
    case commandPalette = "natesclaw:native-toggle-search"
    ...
    var legacyFallbackEventName: String? {
        switch self {
        case .newSession: nil
        case .commandPalette: "natesclaw:native-open-search"
        }
    }
