...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `natesclaw doctor --fix`.";
    case "module-missing":
      return "Fix: run `natesclaw doctor --fix`.";
    case "service-missing":
      return "Fix: run `natesclaw gateway install --force`.";
    case "service-stopped":
      return "Fix: run `natesclaw gateway restart`.";
    case "startup-blocked":
      return "Fix: run `natesclaw gateway status --deep`.";
    case "not-listening":
      return "Fix: start `natesclaw gateway run`, or run `natesclaw gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
