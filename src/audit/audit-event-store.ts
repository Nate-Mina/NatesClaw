...
type AuditEventsTable = NatesclawStateKyselyDatabase["audit_events"];
type AuditDatabase = Pick<NatesclawStateKyselyDatabase, "audit_events">;
...
export function listAuditEvents(params: {
  ...
  const { db } = openNatesclawStateDatabase(params.database);
