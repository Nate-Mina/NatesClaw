...
function webPushStateDatabaseOptions(stateDir?: string): NatesclawStateDatabaseOptions {
  return stateDir
...
export function listWebPushSubscriptions(stateDir?: string): WebPushSubscription[] {
  const database = openNatesclawStateDatabase(webPushStateDatabaseOptions(stateDir));
