...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: NatesclawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: NatesclawConfig; sessionKey: string }): void {
