...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("natesclaw.imageGenerateToolTestApi")] = {
    resolveImageGenerationModelConfigForTool,
  };
}

function hasExplicitImageGenerationModelConfig(cfg?: NatesclawConfig): boolean {
