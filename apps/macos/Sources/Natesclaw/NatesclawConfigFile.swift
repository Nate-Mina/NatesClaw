...
enum NatesclawConfigFile {
    ...
    private static let logger = Logger(subsystem: "ai.natesclaw", category: "config")
...
extension NatesclawConfigFile {
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-natesclaw-config-file",
            "event": "config.write",
