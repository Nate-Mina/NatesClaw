...
- Applying repository-specific documentation overlays, including Natesclaw page-type, docs IA, preservation, and validation rules when present.
...
6. For Natesclaw docs work, read `references/natesclaw.md` before the build/review playbook.
