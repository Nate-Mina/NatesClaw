...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/natesclaw-matrix-create-client-test",
    storagePath: "/tmp/natesclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/natesclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/natesclaw-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "natesclaw-matrix-default-token-hash",
