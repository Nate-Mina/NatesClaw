// Check No Deprecated Channel Access script supports Natesclaw repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']natesclaw\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']natesclaw\/plugin-sdk\/command-auth["']/u,
  },
];
