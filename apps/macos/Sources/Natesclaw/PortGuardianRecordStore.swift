...
/// This intentionally ignores NATESCLAW_STATE_DIR: prod, dev, and profile-specific
...
final class PortGuardianRecordStore: @unchecked Sendable {
    ...
    private let database: NatesclawNativeStateSQLite
    ...
    static var liveRootURL: URL {
        ...
        return base.appendingPathComponent("Natesclaw", isDirectory: true)
    }
        ...
        }) throws
    {
        ...
        let database: NatesclawNativeStateSQLite
        do {
            database = try NatesclawNativeStateSQLite(databaseURL: databaseURL)
        } catch {
    ...
    private static func decodeRecord(
        _ statement: NatesclawNativeStateSQLiteStatement) throws -> PortGuardian.Record
    {
    ...
    private static func bind(
        ...
        to statement: NatesclawNativeStateSQLiteStatement) throws
    {
    ...
    private static func storeError(_ error: Error) -> Error {
        ...
        if let error = error as? NatesclawNativeStateError {
