...
class SkillWorkshopPage extends NatesclawLightDomElement {
...
if (!customElements.get("natesclaw-skill-workshop-page")) {
  customElements.define("natesclaw-skill-workshop-page", SkillWorkshopPage);
}
