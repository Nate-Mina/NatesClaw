...
// isolation is opt-in; `natesclaw security audit` nudges it when traffic warrants.
...
export function applySkipBootstrapConfig(cfg: NatesclawConfig): NatesclawConfig {
