...
actor CameraController {
    ...
    func snap(
        params: NatesclawCameraSnapParams,
        defaultFacing: NatesclawCameraFacing = .front) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(
        params: NatesclawCameraClipParams,
        defaultFacing: NatesclawCameraFacing = .front) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("natesclaw-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("natesclaw-camera-\(UUID().uuidString).mp4")
        defer {
    ...
    nonisolated static func resolveFacing(
        _ explicitFacing: NatesclawCameraFacing?,
        defaultFacing: NatesclawCameraFacing) -> NatesclawCameraFacing
    {
