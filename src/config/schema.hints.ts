...
} from "@natesclaw/net-policy/redact-sensitive-url";
import { z } from "zod";
...
const SECTION_DOCS_URLS = {
  accessGroups: "https://docs.natesclaw.ai/channels/access-groups",
  messages: "https://docs.natesclaw.ai/concepts/messages",
  tts: "https://docs.natesclaw.ai/tts",
  commands: "https://docs.natesclaw.ai/tools/slash-commands",
  hooks: "https://docs.natesclaw.ai/automation/hooks",
  cron: "https://docs.natesclaw.ai/automation/cron-jobs",
  bindings: "https://docs.natesclaw.ai/concepts/agent-bindings",
  plugins: "https://docs.natesclaw.ai/plugins/manage-plugins",
  mcp: "https://docs.natesclaw.ai/tools/mcp",
  memory: "https://docs.natesclaw.ai/concepts/memory",
  talk: "https://docs.natesclaw.ai/nodes/talk",
  gateway: "https://docs.natesclaw.ai/gateway/configuration",
  browser: "https://docs.natesclaw.ai/tools/browser",
  nodeHost: "https://docs.natesclaw.ai/nodes",
  discovery: "https://docs.natesclaw.ai/gateway/discovery",
  acp: "https://docs.natesclaw.ai/tools/acp-agents",
  agents: "https://docs.natesclaw.ai/concepts/agent",
  models: "https://docs.natesclaw.ai/concepts/models",
  skills: "https://docs.natesclaw.ai/tools/skills",
  tools: "https://docs.natesclaw.ai/tools",
  session: "https://docs.natesclaw.ai/concepts/session",
  security: "https://docs.natesclaw.ai/gateway/security",
  approvals: "https://docs.natesclaw.ai/tools/exec-approvals",
  env: "https://docs.natesclaw.ai/help/environment",
  auth: "https://docs.natesclaw.ai/concepts/oauth",
  update: "https://docs.natesclaw.ai/install/updating",
  logging: "https://docs.natesclaw.ai/logging",
  diagnostics: "https://docs.natesclaw.ai/gateway/diagnostics",
  cli: "https://docs.natesclaw.ai/cli",
  secrets: "https://docs.natesclaw.ai/gateway/secrets",
  ui: "https://docs.natesclaw.ai/web/control-ui",
  wizard: "https://docs.natesclaw.ai/start/wizard",
  channels: "https://docs.natesclaw.ai/channels",
  broadcast: "https://docs.natesclaw.ai/channels/broadcast-groups",
  audio: "https://docs.natesclaw.ai/nodes/audio",
  voicewake: "https://docs.natesclaw.ai/nodes/voicewake",
  presence: "https://docs.natesclaw.ai/concepts/presence",
  cloudWorkers: "https://docs.natesclaw.ai/gateway/cloud-workers",
  worktrees: "https://docs.natesclaw.ai/concepts/managed-worktrees",
  proxy: "https://docs.natesclaw.ai/security/network-proxy",
  transcripts: "https://docs.natesclaw.ai/plugins/meeting-plugins",
  surfaces: "https://docs.natesclaw.ai/concepts/messages",
...
const FIELD_PLACEHOLDERS: Record<string, string> = {
  ...
  "gateway.controlUi.basePath": "/natesclaw",
  "gateway.controlUi.root": "dist/control-ui",
  "gateway.controlUi.allowedOrigins": "https://control.example.com",
  "gateway.push.apns.relay.baseUrl": "https://ios-push-relay.natesclaw.ai",
  "channels.mattermost.baseUrl": "https://chat.example.com",
  "agents.entries.*.identity.avatar": "avatars/natesclaw.png",
};
