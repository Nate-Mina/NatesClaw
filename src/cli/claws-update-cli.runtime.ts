...
import { openExistingNatesclawStateDatabaseReadOnly } from "../state/natesclaw-state-db.js";
...
export async function runClawsUpdateCommand(
  ...
  if (!source) {
    const database = await openExistingNatesclawStateDatabaseReadOnly();
  ...
  const plan = await buildClawUpdatePlan({
    ...
    targetNatesclawProfile: loaded.NatesclawProfile,
