...
import type { ConfiguredBindingRouteResult } from "natesclaw/plugin-sdk/conversation-binding-runtime";
...
vi.mock("natesclaw/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("natesclaw/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("natesclaw/plugin-sdk/routing")>();
  return {
    ...actual,
