...
const RESTART_SAFE_CHAT_REQUEST_VERIFIER_DOMAIN = "natesclaw.chat.restart-retry.v1";
...
function hasRestartUnsafeMessageSemantics(rawMessage: string, cfg: NatesclawConfig): boolean {
  if (
