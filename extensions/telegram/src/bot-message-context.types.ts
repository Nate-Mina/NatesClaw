...
type ResolveGroupRequireMention = (chatId: string | number, cfg: NatesclawConfig) => boolean;
...
export type BuildTelegramMessageContextParams = {
  ...
  upsertPairingRequest?: typeof import("natesclaw/plugin-sdk/conversation-runtime").upsertChannelPairingRequest;
