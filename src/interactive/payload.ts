...
import { asOptionalRecord as toRecord } from "@natesclaw/normalization-core/record-coerce";
import {
...
const PRESENTATION_FALLBACK_CONTINUATION = Symbol.for(
  "natesclaw.presentation.fallback-continuation",
);
...
export type MessagePresentationAction =
  ...
  | {
      ...
      url: string;
      /** Natesclaw hosted-widget ID whose launch mechanics are owned by the channel. */
      widgetId?: string;
    }
  | {
      /** Launch a channel-native web app. */
