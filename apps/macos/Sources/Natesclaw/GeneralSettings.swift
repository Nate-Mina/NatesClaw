...
struct GeneralSettings: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .natesclawPermissionsChanged)) { _ in
            self.refreshComputerControlPermissions()
        }
    ...
    private var generalPage: some View {
        VStack(alignment: .leading, spacing: 20) {
            SettingsPageHeader(
                title: "General",
                subtitle: "Everyday Natesclaw app behavior.")

            self.NatesclawStatusPanel
            ...
            SettingsCardGroup("App") {
                ...
                SettingsCardToggleRow(
                    ...
                    subtitle: """
                    Keep Natesclaw visible in the Dock. When off, windows still show the Dock icon while open.
                    """,
    ...
    private var NatesclawStatusPanel: some View {
        ...
        return HStack(alignment: .center, spacing: 14) {
            ...
            Toggle("Natesclaw active", isOn: self.activeBinding)
                .labelsHidden()
                .toggleStyle(.switch)
        }
    ...
    private var connectionStatusSubtitle: String {
        ...
        switch self.state.connectionMode {
        case .local:
            return "Natesclaw starts and monitors the Gateway on this Mac."
        case .remote:
        ...
        SettingsCardGroup("Advanced") {
            DisclosureGroup(isExpanded: self.$showRemoteAdvanced) {
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    self.advancedTextField(
                        "Project root",
                        placeholder: "/home/you/Projects/natesclaw",
                        text: self.$state.remoteProjectRoot)
                    self.advancedTextField(
                        "CLI path",
                        placeholder: "/Applications/Natesclaw.app/.../natesclaw",
...
extension GeneralSettings {
    ...
    private func revealLogs() {
        ...
        Looked for natesclaw logs in /tmp/natesclaw/.
        ...
        isEnabled: Bool) -> Self
    {
        ...
        return Self(
            subtitle: bundleLocationAllowsPersistentIntegration
                ? String(localized: "Automatically start Natesclaw after you sign in.")
                : String(localized: "Move Natesclaw to Applications before enabling launch at login."),
