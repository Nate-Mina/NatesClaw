...
// Summarizes Natesclaw performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node --import tsx scripts/natesclaw-performance-source-summary.mts --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes Natesclaw-native performance probe artifacts for CI reports.`);
}
