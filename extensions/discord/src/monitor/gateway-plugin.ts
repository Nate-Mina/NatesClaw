...
import { createNodeProxyAgent } from "natesclaw/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("natesclaw/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class NatesclawGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new NatesclawGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // Natesclaw registers its own async interaction listener.
