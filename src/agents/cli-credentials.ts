...
function resolveCodexHomePath(codexHome?: string) {
  ...
  // External CLI state belongs to the OS user, not Natesclaw's relocatable
  // home. Otherwise an isolated NATESCLAW_HOME hides an already logged-in CLI.
...
if (process.env.VITEST || process.env.NODE_ENV === "test") {
  (globalThis as Record<PropertyKey, unknown>)[Symbol.for("natesclaw.cliCredentialsTestApi")] = {
