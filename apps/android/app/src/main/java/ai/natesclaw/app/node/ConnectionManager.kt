...
import ai.natesclaw.app.gateway.GatewayClientInfo
...
class ConnectionManager internal constructor(
  ...
  fun buildUserAgent(): String {
    ...
    return "NatesclawAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "natesclaw-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(
    ...
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "natesclaw-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
