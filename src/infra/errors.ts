...
import { formatErrorMessage as formatSharedErrorMessage } from "@natesclaw/normalization-core/error-coercion";
...
export { stringifyNonErrorCause, toErrorObject } from "@natesclaw/normalization-core/error-coercion";
