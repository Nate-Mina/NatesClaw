 ...
 * pairs directly into the provider payload, so Natesclaw must normalize here.
 */
 ...
 *
 * Natesclaw persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata
