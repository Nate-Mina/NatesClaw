...
EXPECTED_COMMIT="$(natesclaw_trim_build_metadata_value "${EXPECTED_COMMIT}")"
if ! natesclaw_is_full_git_commit "${EXPECTED_COMMIT}"; then
...
if ! natesclaw_is_full_git_commit "${CHECKOUT_COMMIT}"; then
