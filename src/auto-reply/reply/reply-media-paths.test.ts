...
describe("createReplyMediaPathNormalizer", () => {
  ...
  it("stages absolute workspace media paths before sandbox mapping", async () => {
    ...
    const absolutePath = "/Users/peter/.natesclaw/workspace/reports/screenshot.png";
    const normalize = createReplyMediaPathNormalizer({
      cfg: {},
      sessionKey: "session-key",
      workspaceDir: "/Users/peter/.natesclaw/workspace",
    });
  ...
  it("stages absolute workspace media paths so the PR scenario now works", async () => {
    const absolutePath = "/Users/peter/.natesclaw/workspace/exports/images/chart.png";
    const normalize = createReplyMediaPathNormalizer({
  ...
  it("keeps managed generated media under the shared media root", async () => {
    setTestEnvValue("NATESCLAW_STATE_DIR", "/Users/peter/.natesclaw");
    const normalize = createTestReplyMediaNormalizer();

    const result = await normalize({
      mediaUrls: ["/Users/peter/.natesclaw/media/tool-image-generation/generated.png"],
    });

    expectMedia(result, "/Users/peter/.natesclaw/media/tool-image-generation/generated.png", [
      "/Users/peter/.natesclaw/media/tool-image-generation/generated.png",
    ]);
    expect(resolveOutboundAttachmentFromUrl).not.toHaveBeenCalled();
  });
  ...
  it("keeps managed outbound media under the shared media root with sandbox mapping", async () => {
    ...
    const result = await normalize({
      mediaUrls: ["/Users/peter/.natesclaw/media/outbound/generated.png"],
    });

    expectMedia(result, "/Users/peter/.natesclaw/media/outbound/generated.png", [
      "/Users/peter/.natesclaw/media/outbound/generated.png",
    ]);
    expect(resolveOutboundAttachmentFromUrl).not.toHaveBeenCalled();
  });
  ...
  it("drops managed outbound media symlinks escaping the shared media root without sandbox mapping", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "natesclaw-reply-media-state-"));
    const outsideDir = await fs.mkdtemp(path.join(os.tmpdir(), "natesclaw-reply-media-outside-"));
