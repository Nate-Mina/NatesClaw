...
internal const val extraWearLaunchTarget = "natesclaw.wear.launchTarget"
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContent {
      ...
      if (scene == null) {
        ...
        NatesclawWearScreenshotApp(scene)
      }
    }
  }
...
internal fun NatesclawWearApp(
  ...
  NatesclawWearTheme(themeMode = themeMode) {
    AppScaffold {
      NatesclawWearScreens(
        snapshot = snapshot,
        failure = failure,
        ...
        onTalk = {
          if (!state.connected || snapshot?.activeSessionId == null) return@NatesclawWearScreens
...
internal const val REPLY_RESULT_KEY = "natesclaw_watch_message"
