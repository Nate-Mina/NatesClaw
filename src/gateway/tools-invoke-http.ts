...
export async function handleToolsInvokeHttpRequest(
  ...
  try {
    ...
    const messageChannel = normalizeMessageChannel(
      getHeader(req, "x-natesclaw-message-channel") ?? "",
    );
    const accountId = normalizeOptionalString(getHeader(req, "x-natesclaw-account-id"));
    const agentTo = normalizeOptionalString(getHeader(req, "x-natesclaw-message-to"));
    const agentThreadId = normalizeOptionalString(getHeader(req, "x-natesclaw-thread-id"));
