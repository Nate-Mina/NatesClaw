...
class ThemeModeToggle extends NatesclawLightDomContentsElement {
...
if (!customElements.get("natesclaw-theme-mode-toggle")) {
  customElements.define("natesclaw-theme-mode-toggle", ThemeModeToggle);
}
