 ...
 */
import { resolveAwsSdkEnvVarName } from "natesclaw/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "natesclaw/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells Natesclaw to use AWS SDK credentials. */
