...
type GatewayInstallAuthMode = NonNullable<NonNullable<NatesclawConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: NatesclawConfig): boolean {
...
function hasDurableGatewayPasswordEnvForInstall(
  ...
  return Boolean(
    normalizeOptionalString(durableServiceEnv.NATESCLAW_GATEWAY_PASSWORD) ||
