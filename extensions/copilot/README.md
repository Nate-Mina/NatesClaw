# GitHub Copilot agent runtime (Natesclaw plugin)

External Natesclaw plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. Natesclaw remains the default embedded runtime.
