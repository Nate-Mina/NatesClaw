...
/**
 * Runtime context resolver for Natesclaw plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking Natesclaw plugin tools. */
...
export function resolveNatesclawPluginToolInputs(params: {
  options?: NatesclawPluginToolOptions;
