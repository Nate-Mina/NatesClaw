...
import { buildTimeoutAbortSignal } from "natesclaw/plugin-sdk/extension-shared";
import {
  asDateTimestampMs,
...
const VERTEX_ADC_TEST_API_KEY = Symbol.for("natesclaw.google.vertexAdcTestApi");
 ...
 *      Natesclaw, included for completeness).
 ...
 * existing fetchImpl test seam and the Natesclaw upstream behaviour); when the
