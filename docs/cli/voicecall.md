---
summary: "CLI reference for `natesclaw voicecall` (voice-call plugin command surface)"
read_when:
...
natesclaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
natesclaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
natesclaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
natesclaw voicecall continue --call-id <id> --message <text>
natesclaw voicecall speak    --call-id <id> --message <text>
natesclaw voicecall dtmf     --call-id <id> --digits <digits>
natesclaw voicecall end      --call-id <id>
natesclaw voicecall status   [--call-id <id>] [--json]
natesclaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
natesclaw voicecall latency  [--file <path>] [--last <n>]
natesclaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `Natesclaw voice call smoke test.` | Message to speak during the smoke call. |
...
natesclaw voicecall smoke --to "+15555550123"        # dry run
natesclaw voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
natesclaw voicecall call --to "+15555550123" --message "Hello"
natesclaw voicecall call -m "Heads up" --mode notify
```
...
```bash
natesclaw voicecall status
natesclaw voicecall status --json
...
```bash
natesclaw voicecall expose --mode serve
natesclaw voicecall expose --mode funnel
natesclaw voicecall expose --mode off
```
