...
export const DEFAULT_SANDBOX_IMAGE = "natesclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "natesclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "natesclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "natesclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "natesclaw-sbx-browser-";
