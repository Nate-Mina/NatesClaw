...
import { normalizeOptionalAccountId } from "natesclaw/plugin-sdk/account-core";
...
function resolveQuoteLookupAccountId(cfg?: NatesclawConfig, accountId?: string | null): string {
