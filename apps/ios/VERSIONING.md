# Natesclaw iOS Versioning

Natesclaw iOS releases retain their gateway association while allowing multiple
...
- `NatesclawCanonicalVersion = 2026.7.2`
...
```text
refs/natesclaw/mobile-releases/ios/<CFBundleShortVersionString>-<CFBundleVersion>
```

For example:

```text
refs/natesclaw/mobile-releases/ios/2026.7.21-3
```
