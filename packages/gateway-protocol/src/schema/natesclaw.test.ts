...
describe("Natesclaw chat params protocol", () => {
...
describe("Natesclaw chat question protocol", () => {
  const question = {
...
describe("Natesclaw chat history protocol", () => {
...
describe("Natesclaw setup detection protocol", () => {
      ...
      unavailableCandidates: [
        {
          ...
          reason: "Reconnect through Natesclaw or use a Gemini API key.",
...
describe("Natesclaw setup verification protocol", () => {
