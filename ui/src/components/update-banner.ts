...
class UpdateBanner extends NatesclawLightDomContentsElement {
...
if (!customElements.get("natesclaw-update-banner")) {
  customElements.define("natesclaw-update-banner", UpdateBanner);
}
