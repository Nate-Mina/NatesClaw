...
struct GlowingNatesclawIcon: View {
    ...
    let accessory: NatesclawMascotAccessory
    ...
    var body: some View {
        ...
        NatesclawMascotView(
            ...
            .shadow(
                color: NatesclawMascotView.heroGlowColor(for: self.colorScheme),
...
extension OnboardingView {
    ...
    var mascotMood: NatesclawMascotMood {
    ...
    var mascotAccessory: NatesclawMascotAccessory {
    ...
    static func mascotMood(for snapshot: MascotMoodSnapshot) -> NatesclawMascotMood {
    ...
    static func mascotAccessory(for page: MascotPage) -> NatesclawMascotAccessory {
        switch page {
        case .ready: .gradCap
