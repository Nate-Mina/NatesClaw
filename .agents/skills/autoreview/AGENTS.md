...
- Canonical source: `natesclaw/agent-skills`, under `skills/autoreview`.
- Before editing any copy, fast-forward a checkout of `natesclaw/agent-skills` from `origin/main`.
