...
class SessionMenu extends NatesclawLightDomElement {
  ...
  override connectedCallback() {
    ...
    // through it (same pattern as natesclaw-native-link-menu).
...
if (!customElements.get("natesclaw-session-menu")) {
  customElements.define("natesclaw-session-menu", SessionMenu);
}
