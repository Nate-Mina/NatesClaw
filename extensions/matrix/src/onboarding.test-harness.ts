...
import type { OutputRuntimeEnv } from "natesclaw/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "natesclaw/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Natesclaw Gateway",
    },
    confirm: {
