...
const TEST_AGENT_DIR = "/tmp/natesclaw-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: NatesclawConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: NatesclawConfig) => {
