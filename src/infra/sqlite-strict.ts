// Migrates Natesclaw-owned SQLite tables to canonical STRICT schemas.
...
const STRICT_MIGRATION_TABLE_PREFIX = "__natesclaw_strict_migration_";
...
/** Atomically upgrade Natesclaw-owned tables described by a canonical STRICT schema. */
