// Removes transient runtime state from restorable Natesclaw database snapshots.
...
type SnapshotSanitizerDatabase = Pick<NatesclawStateKyselyDatabase, "exec_approvals_config">;
...
export function sanitizeNatesclawStateLeaseRows(database: DatabaseSync): void {
...
export function sanitizeNatesclawGlobalStateSnapshot(database: DatabaseSync): void {
