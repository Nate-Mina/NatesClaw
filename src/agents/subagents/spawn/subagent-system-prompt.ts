    ...
    lines.push(
      ...
      ...(acpEnabled
        ? [
            ...
            "`agents_list`/`subagents` = Natesclaw runtime=subagent only; ACP ids from `acp.allowedAgents`.",
            "Never ask user for slash/CLI or exec natesclaw/acpx when sessions_spawn can act.",
