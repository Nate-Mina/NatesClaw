...
import SHARED_TOOL_DISPLAY_JSON from "../../../../apps/shared/NatesclawKit/Sources/NatesclawKit/Resources/tool-display.json" with { type: "json" };
import {
  defaultTitle,
...
const A2UI_PATH = "/__natesclaw__/a2ui";
const CANVAS_HOST_PATH = "/__natesclaw__/canvas";
const CANVAS_CAPABILITY_PATH_PREFIX = "/__natesclaw__/cap";
