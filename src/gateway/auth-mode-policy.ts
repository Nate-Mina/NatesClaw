...
export function hasAmbiguousGatewayAuthModeConfig(cfg: NatesclawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: NatesclawConfig): void {
