...
class ChatSidebarRegion extends NatesclawLightDomElement {
  ...
  private startDrag(event: DragEvent, panelId: string) {
    ...
    event.dataTransfer?.setData("application/x-natesclaw-sidebar-panel", panelId);
...
if (!customElements.get("natesclaw-chat-sidebar-region")) {
  customElements.define("natesclaw-chat-sidebar-region", ChatSidebarRegion);
}

declare global {
  interface HTMLElementTagNameMap {
    "natesclaw-chat-sidebar-region": ChatSidebarRegion;
  }
}
