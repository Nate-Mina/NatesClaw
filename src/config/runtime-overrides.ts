...
function applyOverrideTree(cfg: NatesclawConfig, overrideTree: OverrideTree): NatesclawConfig {
  const next = mergeOverrides(cfg, overrideTree) as NatesclawConfig;
...
export function applyConfigOverrides(cfg: NatesclawConfig): NatesclawConfig {
...
export function captureConfigOverrideApplier(): (cfg: NatesclawConfig) => NatesclawConfig {
