/**
 * Fast Natesclaw tool-bundle mock.
 *
...
const createNatesclawToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("natesclaw-tools:test-helper");
    return coreTools
...
vi.mock("../natesclaw-tools.js", async (importOriginal) => {
  ...
  return {
    createNatesclawTools: createNatesclawToolsMock,
