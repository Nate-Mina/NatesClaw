...
export function collectMissingDefaultAccountBindingWarnings(cfg: NatesclawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: NatesclawConfig): string[] {
  const warnings: string[] = [];
