...
type XaiAutoEnableProbe = Parameters<NatesclawPluginApi["registerAutoEnableProbe"]>[0];
...
function registerXaiBilledToolFactories() {
  const tools = new Map<string, Parameters<NatesclawPluginApi["registerTool"]>[0]>();
  plugin.register(
    createTestPluginApi({
