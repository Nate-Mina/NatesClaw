---
name: healthcheck
description: "Audit/harden Natesclaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Natesclaw host healthcheck
...
- Never claim Natesclaw manages OS firewall, SSH, or updates.
...
- Natesclaw gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `natesclaw security audit --deep`.
