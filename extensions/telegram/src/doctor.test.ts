...
const DOCTOR_FIX_COMMAND = "natesclaw doctor --fix";

async function collectPreviewWarnings(cfg: NatesclawConfig, env?: NodeJS.ProcessEnv) {
...
async function repairConfig(cfg: NatesclawConfig) {
...
vi.mock("natesclaw/plugin-sdk/runtime", () => {
  return {
