...
export type NatesclawPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type NatesclawPluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified Natesclaw runtime.
   */
  activeModel?: NatesclawPluginActiveModelContext;
  browser?: {
...
export type NatesclawPluginToolFactory = (
  ctx: NatesclawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type NatesclawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type NatesclawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
