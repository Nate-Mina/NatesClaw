...
function resolveConfiguredCommandOwners(cfg: NatesclawConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: NatesclawConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: NatesclawConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("natesclaw config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,
