...
class NatesclawWorkboardCardWidget extends WorkboardWidgetElement {
...
if (!customElements.get("natesclaw-workboard-card-widget")) {
  customElements.define("natesclaw-workboard-card-widget", NatesclawWorkboardCardWidget);
}
...
export const renderWorkboardCardWidget: PluginBoardWidgetRenderer = ({
  ...
  <natesclaw-workboard-card-widget
    .widget=${widget}
...
declare global {
  interface HTMLElementTagNameMap {
    "natesclaw-workboard-card-widget": NatesclawWorkboardCardWidget;
  }
}
