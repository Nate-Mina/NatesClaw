...
const TEXT_BODY = "Natesclaw web_fetch direct text benchmark body.".repeat(160);
...
const toolConfig: NatesclawConfig = {
  tools: {
    web: {
      fetch: {
        cacheTtlMinutes: 0,
...
function printUsage(): void {
  process.stdout.write(`Natesclaw web_fetch benchmark
