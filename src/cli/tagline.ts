...
const DEFAULT_TAGLINE = "All your chats, one Natesclaw.";
...
const TAGLINES: string[] = [
  ...
  "You had me at 'natesclaw gateway start.'",
  ...
  "If found wandering, please return to ~/.natesclaw.",
  ...
  "Natesclaw Support will never DM you first. I, on the other hand, absolutely will.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.NATESCLAW_TAGLINE_INDEX;
