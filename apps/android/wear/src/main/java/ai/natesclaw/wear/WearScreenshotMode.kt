...
internal const val extraWearScreenshotMode = "natesclaw.screenshotMode"
internal const val extraWearScreenshotScene = "natesclaw.screenshotScene"
...
@Composable
internal fun NatesclawWearScreenshotApp(scene: WearScreenshotScene) {
  NatesclawWearTheme(themeMode = WearThemeMode.Dark) {
    AppScaffold {
