...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.natesclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Natesclaw windows, but below the system’s pop-up menus.
