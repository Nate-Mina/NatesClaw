...
const SKILL_SOURCE_GROUPS: Array<{ id: string; labelKey: string; sources: string[] }> = [
  { id: "workspace", labelKey: "skillGroups.workspace", sources: ["natesclaw-workspace"] },
  { id: "built-in", labelKey: "skillGroups.builtIn", sources: ["natesclaw-bundled"] },
  { id: "installed", labelKey: "skillGroups.installed", sources: ["natesclaw-managed"] },
  { id: "extra", labelKey: "skillGroups.extra", sources: ["natesclaw-extra"] },
];
