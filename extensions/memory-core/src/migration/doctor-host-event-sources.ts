...
import { root } from "natesclaw/plugin-sdk/memory-core-host-engine-fs";
...
export async function collectLegacyMemoryHostEventSources(
  ...
  const { resolveMemoryHostEventLogPath } = await import("natesclaw/plugin-sdk/memory-host-events");
