...
/**
 * Env var carrying the *effective* update channel into `natesclaw update finalize`
 ...
 * channel split (`NATESCLAW_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "NATESCLAW_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an Natesclaw update channel to the npm dist-tag used for package lookups. */
