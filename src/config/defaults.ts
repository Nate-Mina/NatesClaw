...
export function applyMessageDefaults(cfg: NatesclawConfig): NatesclawConfig {
...
export function applyTalkConfigNormalization(config: NatesclawConfig): NatesclawConfig {
...
export function applyAgentDefaults(cfg: NatesclawConfig): NatesclawConfig {
...
export function applyCronDefaults(cfg: NatesclawConfig): NatesclawConfig {
  return cfg;
}

export function applyLoggingDefaults(cfg: NatesclawConfig): NatesclawConfig {
  return cfg;
}

function hasAnthropicDefaultSignal(cfg: NatesclawConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: NatesclawConfig): NatesclawConfig {
