...
import type { NatesclawPluginGatewayEvents, PluginRuntime } from "natesclaw/plugin-sdk/core";
import type {
  SessionDiscussionInfo,
  SessionDiscussionProvider,
} from "natesclaw/plugin-sdk/session-discussion";
...
type DiscussionServiceOptions = {
  ...
  gatewayEvents?: Pick<NatesclawPluginGatewayEvents, "onSessionsChanged">;
  startTimer?: boolean;
...
export class ClickClackDiscussionService {
  ...
  bindGatewayEvents(
    gatewayEvents: Pick<NatesclawPluginGatewayEvents, "onSessionsChanged"> | undefined,
  ): void {
