...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.natesclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> NatesclawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: NatesclawSessionPreviewEntry,
    ...
    private static func cache(payload: NatesclawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: NatesclawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [NatesclawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [NatesclawKit.AnyCodable]) -> [NatesclawChatMessage] {
    ...
    private static func previewText(for message: NatesclawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: NatesclawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: NatesclawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: NatesclawChatMessage) -> String? {
