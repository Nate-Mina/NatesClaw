...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "natesclaw doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

function migrateOllamaCloudRetiredBaseUrl(config: NatesclawConfig): {
  ...
  nextConfig.models = nextModels as NatesclawConfig["models"];
