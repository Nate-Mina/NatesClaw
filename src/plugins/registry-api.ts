...
import type { NatesclawPluginApi, PluginLogger, PluginRegistrationMode } from "./types.js";
          ...
          ? {
              ...
              enqueueNextTurnInjection: (injection) => {
                ...
                return enqueuePluginNextTurnInjection({
                  cfg: registryParams.runtime.config.current() as NatesclawConfig,
                  pluginId: record.id,
              ...
              sendSessionAttachment: async (attachment) => {
                ...
                try {
                  ...
                  const runtimeConfig =
                    (registryParams.runtime.config?.current?.() as NatesclawConfig | undefined) ??
                    params.config;
