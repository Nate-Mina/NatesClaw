import type { SessionDiscussionInfo } from "natesclaw/plugin-sdk/session-discussion";
...
export function discussionInfoForBinding(
  ...
  return {
    ...
    embedUrl: `${baseUrl}/embed/channel/${encodeURIComponent(binding.workspaceRouteId)}/${encodeURIComponent(binding.channelRouteId)}?natesclawHostTheme=1`,
