...
import { applyAccountNameToChannelSection } from "natesclaw/plugin-sdk/setup";
import { DEFAULT_ACCOUNT_ID } from "natesclaw/plugin-sdk/setup-runtime";
...
function resolveComparableCurrentKey(cfg: NatesclawConfig): string | undefined {
