...
} from "natesclaw/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<NatesclawConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: NatesclawConfig) {
