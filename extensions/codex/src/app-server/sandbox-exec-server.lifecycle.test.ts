...
import type { ManagedProcess, NatesclawExecServer } from "./sandbox-exec-server/types.js";
...
function createExecServer(sandbox: SandboxContext): NatesclawExecServer {
  return { sandbox } as NatesclawExecServer;
}
