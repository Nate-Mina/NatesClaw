...
function hasExplicitMemorySearchConfig(cfg: NatesclawConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: NatesclawConfig): MemoryPluginStatus {
