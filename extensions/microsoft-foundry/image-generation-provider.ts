...
import type { ProviderRuntimeModel } from "natesclaw/plugin-sdk/core";
...
type ModelProviderConfig = NonNullable<NonNullable<NatesclawConfig["models"]>["providers"]>[string];
