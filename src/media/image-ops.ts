...
/** Natesclaw-facing image backend availability error, preserving the failed operation and causes. */
...
/** Creates a Rastermill processor with Natesclaw temp-dir, pixel-limit, and command trust policy. */
...
/** Detects either Natesclaw's wrapper error or Rastermill's native unavailable error. */
