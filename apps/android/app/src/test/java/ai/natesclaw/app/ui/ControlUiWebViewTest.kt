  ...
  fun pinnedSslError_proceedsOnlyForExactCertificateAtGatewayOrigin() {
    ...
    assertTrue(
      shouldProceedForPinnedControlUiSslError(
        pageBaseUrl = "https://gateway.example.com:8443/natesclaw/",
        expectedFingerprint = fingerprint,
        errorUrl = "https://gateway.example.com:8443/natesclaw/assets/app.js",
    ...
    assertFalse(
      shouldProceedForPinnedControlUiSslError(
        pageBaseUrl = "https://gateway.example.com:8443/natesclaw/",
        expectedFingerprint = fingerprint,
        errorUrl = "https://attacker.example.com:8443/natesclaw/assets/app.js",
        encodedCertificate = certificate,
      ),
    )
    assertFalse(
