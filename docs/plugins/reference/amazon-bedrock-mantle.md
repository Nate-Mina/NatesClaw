---
summary: "Natesclaw Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
Natesclaw Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.
