...
enum ConfigStore {
    ...
    static func load() async -> [String: Any] {
        ...
        return NatesclawConfigFile.loadDict()
    }
        ...
        allowGatewayAuthMutation: Bool = false) async throws
    {
        ...
        if await self.isRemoteMode() {
            ...
            if let override = overrides.saveLocal {
                ...
                do {
                    ...
                    guard NatesclawConfigFile.saveDict(
                        root,
        ...
        #endif
        notificationCenter.post(name: .natesclawConfigDidChange, object: nil)
    }
...
extension Notification.Name {
    static let natesclawConfigDidChange = Notification.Name("natesclaw.config.did-change")
}
