...
/** Minimal transport interface consumed by the Natesclaw SDK client. */
export type NatesclawTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableNatesclawTransport = NatesclawTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "natesclaw" | "codex" | (string & {}) }
...
export type NatesclawEventType =
  | "run.created"
  | "run.queued"
  | "run.started"
  | "run.completed"
...
export type NatesclawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: NatesclawEventType;
  runId?: string;
  sessionId?: string;
  sessionKey?: string;
  taskId?: string;
