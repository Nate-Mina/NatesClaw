...
describe("Slack approval actions", () => {
  ...
  it.each([
    "callback",
    "natesclaw:approval:v1:not-json",
    'natesclaw:approval:v1:{"approvalId":"req-1","decision":"allow-once"}',
    'natesclaw:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"accept"}',
    'natesclaw:approval:v1:{"approvalId":"req-1","approvalKind":"exec","decision":"deny","extra":true}',
