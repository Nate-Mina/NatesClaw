...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "natesclaw/plugin-sdk/config-contracts";
...
export function listWhatsAppAuthDirs(cfg: NatesclawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: NatesclawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: NatesclawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: NatesclawConfig): ResolvedWhatsAppAccount[] {
