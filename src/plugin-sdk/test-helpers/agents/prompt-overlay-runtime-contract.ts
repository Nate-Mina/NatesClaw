...
export function openAiPluginPersonalityConfig(personality: "friendly" | "off"): NatesclawConfig {
  return {
    plugins: {
      entries: {
        openai: {
...
export function sharedGpt5PersonalityConfig(_personality: "friendly" | "off"): NatesclawConfig {
  return {};
}
...
export function codexPromptOverlayContext(params?: {
  ...
  return {
    ...
    promptMode: "full",
    agentDir: "/tmp/natesclaw-codex-prompt-contract-agent",
    workspaceDir: "/tmp/natesclaw-codex-prompt-contract-workspace",
