...
function apnsStateDatabaseOptions(stateDir?: string): NatesclawStateDatabaseOptions {
  return stateDir
...
export async function loadApnsRegistration(
  ...
  const database = openNatesclawStateDatabase(apnsStateDatabaseOptions(baseDir));
