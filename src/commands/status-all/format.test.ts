...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://natesclaw.local")).toBe("https://natesclaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://natesclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: natesclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://natesclaw.local" },
      ...
      { Item: "Security", Value: "Run: natesclaw security audit --deep" },
