...
const DEFAULT_CLAWHUB_SOURCE_REPO = "natesclaw/clawhub";
const CLAWHUB_DOCS_TARGET_DIR = "clawhub";
const CLAWHUB_REPO_ENV = "NATESCLAW_DOCS_SYNC_CLAWHUB_REPO";
...
const SYNC_SUPPORT_FILES = [
  {
    ...
    target: path.join(".natesclaw-sync", "check-docs-mdx.mjs"),
  },
  {
    source: path.join(ROOT, "scripts", "check-docs-mdx.mts"),
    target: path.join(".natesclaw-sync", "check-docs-mdx.mts"),
  },
  {
    source: path.join(ROOT, "scripts", "lib", "tsx-cli-shim.mjs"),
    target: path.join(".natesclaw-sync", "lib", "tsx-cli-shim.mjs"),
  },
  {
    source: path.join(ROOT, "scripts", "lib", "mintlify-accordion.mjs"),
    target: path.join(".natesclaw-sync", "lib", "mintlify-accordion.mjs"),
  },
  {
    source: path.join(ROOT, ".github", "codex", "prompts", "docs-mdx-repair.md"),
    target: path.join(".natesclaw-sync", "docs-mdx-repair.md"),
  },
];
...
export function parseArgs(argv) {
  const args = {
    ...
    clawhubSourceRepo:
      process.env.NATESCLAW_DOCS_SYNC_CLAWHUB_SOURCE_REPO || DEFAULT_CLAWHUB_SOURCE_REPO,
    clawhubSourceSha: process.env.NATESCLAW_DOCS_SYNC_CLAWHUB_SOURCE_SHA || "",
  };
...
function writeSyncMetadata(targetRoot, args, sources) {
  ...
  writeJson(path.join(targetRoot, ".natesclaw-sync", "source.json"), metadata);
}
