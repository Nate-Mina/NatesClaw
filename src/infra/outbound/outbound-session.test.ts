...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as NatesclawConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as NatesclawConfig;
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        sessionKey: "agent:main:natesclaw-weixin:direct:wxid_abc123@im.wechat",
        from: "natesclaw-weixin:wxid_abc123@im.wechat",
