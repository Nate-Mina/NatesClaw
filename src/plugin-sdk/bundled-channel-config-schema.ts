/**
 * Bundled-channel config schemas for Natesclaw-maintained plugins.
 *
 * Third-party plugins should define plugin-local schemas and import primitives
 * from natesclaw/plugin-sdk/channel-config-schema instead of depending on these
...
type ChannelConfig = NonNullable<NatesclawConfig["channels"]>;
