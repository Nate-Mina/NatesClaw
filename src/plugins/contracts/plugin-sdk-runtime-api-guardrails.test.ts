...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  [contractPluginPath({
    ...
    'export type { NatesclawPluginServiceContext } from "./api.js";',
  ],
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin } from "natesclaw/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "natesclaw/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "natesclaw/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiNatesclawConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [contractPluginPath({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "natesclaw/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema, GoogleChatConfigSchema } from "./config-api.js";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "natesclaw/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "natesclaw/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "natesclaw/plugin-sdk/channel-outbound";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "natesclaw/plugin-sdk/runtime-group-policy";',
    ...
    'export type { GoogleChatAccountConfig, GoogleChatConfig } from "natesclaw/plugin-sdk/config-contracts";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "natesclaw/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "natesclaw/plugin-sdk/webhook-request-guards";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "natesclaw/plugin-sdk/allow-from";',
      'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "natesclaw/plugin-sdk/channel-contract";',
      ...
      'export { createChannelMessageReplyPipeline } from "natesclaw/plugin-sdk/channel-outbound";',
      'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "natesclaw/plugin-sdk/channel-status";',
      'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "natesclaw/plugin-sdk/channel-targets";',
      'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsCloudName, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, NatesclawConfig } from "natesclaw/plugin-sdk/config-contracts";',
      'export { isDangerousNameMatchingEnabled } from "natesclaw/plugin-sdk/dangerous-name-runtime";',
      ...
      'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "natesclaw/plugin-sdk/media-runtime";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "natesclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext } from "natesclaw/plugin-sdk/channel-contract";',
    'export type { NatesclawConfig } from "natesclaw/plugin-sdk/config-contracts";',
    ...
    'export type { RuntimeEnv } from "natesclaw/plugin-sdk/runtime-env";',
  ...
  [contractPluginPath({
    ...
    'export { createChannelPairingController } from "natesclaw/plugin-sdk/channel-pairing";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, NatesclawConfig } from "natesclaw/plugin-sdk/config-contracts";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "natesclaw/plugin-sdk/runtime-group-policy";',
    'export { createChannelMessageReplyPipeline } from "natesclaw/plugin-sdk/channel-outbound";',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      ...
      'export type { NatesclawPluginService, NatesclawPluginServiceContext, PluginLogger } from "natesclaw/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "natesclaw/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "natesclaw/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "natesclaw/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "natesclaw/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "natesclaw/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "natesclaw/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "natesclaw/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "natesclaw/plugin-sdk/channel-core";',
      'export type { NatesclawConfig } from "natesclaw/plugin-sdk/config-contracts";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeNatesclawConfig["channels"]>["telegram"] >;',
  ...
  [contractPluginPath({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "natesclaw/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "natesclaw/plugin-sdk/channel-core";',
  ...
  [contractPluginPath({
    ...
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "natesclaw/plugin-sdk/webhook-request-guards";',
    ...
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "natesclaw/plugin-sdk/tts-runtime";',
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const [pluginId, rootDir] of getBundledPluginRoots().entries()) {
      ...
      ).not.toContain(`"natesclaw/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'natesclaw/plugin-sdk/${pluginId}'`);
