...
public typealias NatesclawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NatesclawPlatformImage = UIImage
#endif

public enum NatesclawChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct NatesclawChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct NatesclawChatUsageCost: Codable, Hashable, Sendable {
...
public struct NatesclawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NatesclawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NatesclawChatUsageCost.self, forKey: .cost)
        self.total =
...
public enum NatesclawChatPlaybackMode: String, Codable, Hashable, Sendable {
    case native
    case transcode
}

public struct NatesclawChatMessageContent: Codable, Hashable, Sendable {
    ...
    public let playback: NatesclawChatPlaybackMode?
    public let content: AnyCodable?
    public let preview: NatesclawChatCanvasPreview?
    ...
    var mediaKind: NatesclawChatMediaKind? {
    ...
    public init(
        ...
        playback: NatesclawChatPlaybackMode? = nil,
        content: AnyCodable?,
        preview: NatesclawChatCanvasPreview? = nil,
        id: String? = nil,
        name: String? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.playback = try container.decodeIfPresent(NatesclawChatPlaybackMode.self, forKey: .playback)
        ...
        self.preview = try container.decodeIfPresent(NatesclawChatCanvasPreview.self, forKey: .preview)
...
public struct NatesclawChatCanvasPreview: Codable, Hashable, Sendable {
    ...
    public var inlineWidgetPath: String? {
        guard self.kind == "canvas",
              ...
              NatesclawChatWidgetURLResolver.supportsTarget(url)
        else { return nil }
        return url
    }
...
public struct NatesclawChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct NatesclawMetadata: Codable {
        let id: String?
    ...
    public let content: [NatesclawChatMessageContent]
    public let timestamp: Double?
    public let idempotencyKey: String?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NatesclawChatUsage?
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedNatesclaw = try container.decodeIfPresent(NatesclawMetadata.self, forKey: .Natesclaw)
        let decodedIdempotencyKey = try decodedNatesclaw?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(NatesclawChatUsage.self, forKey: .usage)
        ...
        self.transcriptMessageID = decodedNatesclaw?.id
        ...
        let decodedContent: [NatesclawChatMessageContent] = if let decoded = try? container.decode(
            [NatesclawChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [NatesclawChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
            .compactMap { index, mediaPath in
                ...
                return NatesclawChatMessageContent(
                    type: "file",
                    text: nil,
                    mimeType: mimeType,
        ...
        self.isTruncated = decodedNatesclaw?.truncated == true || decodedContent.contains { content in
...
public struct NatesclawChatInFlightRun: Codable, Sendable {
    public let runId: String
    public let text: String
    public let plan: NatesclawChatPlanSnapshot?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(runId: String, text: String, plan: NatesclawChatPlanSnapshot? = nil) {
        self.runId = runId
        self.text = text
        self.plan = plan
    }
...
public struct NatesclawChatPlanSnapshot: Codable, Sendable {
    public let steps: [NatesclawChatPlanStep]
    public let explanation: String?

    // periphery:ignore - package tests construct history fixtures; app consumers decode this payload.
    public init(steps: [NatesclawChatPlanStep], explanation: String? = nil) {
        self.steps = steps
        self.explanation = explanation
    }
}

public struct NatesclawChatSessionInfo: Codable, Sendable {
...
public struct NatesclawChatHistoryPayload: Codable, Sendable {
    public let sessionKey: String
    public let sessionId: String?
    public let messages: [AnyCodable]?
    public let thinkingLevel: String?
    public let sessionInfo: NatesclawChatSessionInfo?
    public let inFlightRun: NatesclawChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: NatesclawChatSessionInfo? = nil,
        inFlightRun: NatesclawChatInFlightRun? = nil)
    {
...
public struct NatesclawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NatesclawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NatesclawSessionPreviewItem]
}

public struct NatesclawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NatesclawSessionPreviewEntry]

    public init(ts: Int, previews: [NatesclawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NatesclawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NatesclawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct NatesclawChatEditorAttachment: Codable, Sendable {
    public let mimeType: String
    public let data: String
}

public struct NatesclawChatRewindResponse: Codable, Sendable {
    public let editorText: String?
    public let editorAttachments: [NatesclawChatEditorAttachment]?
}

public struct NatesclawChatForkAtMessageResponse: Codable, Sendable {
    public let sessionKey: String
    public let editorText: String?
    public let editorAttachments: [NatesclawChatEditorAttachment]?
}

public struct NatesclawChatSessionBranch: Codable, Sendable, Equatable, Identifiable {
...
public struct NatesclawChatSessionBranchesResponse: Codable, Sendable {
    public let branches: [NatesclawChatSessionBranch]

    // periphery:ignore - package tests construct branch fixtures; app consumers decode them.
    public init(branches: [NatesclawChatSessionBranch]) {
        self.branches = branches
    }
}

public struct NatesclawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NatesclawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: NatesclawChatMessage?
...
public struct NatesclawAgentEventPayload: Codable, Sendable, Identifiable {
    public var id: String {
...
public struct NatesclawChatPlanStep: Codable, Hashable, Sendable {
...
public struct NatesclawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct NatesclawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NatesclawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NatesclawPlatformImage?
    public let durationSeconds: Double?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: NatesclawPlatformImage?,
        durationSeconds: Double? = nil)
    {
        self.url = url
        self.data = data
...
public struct NatesclawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
