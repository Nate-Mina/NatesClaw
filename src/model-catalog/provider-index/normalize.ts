...
import type {
  ...
  NatesclawProviderIndexPluginInstall,
  NatesclawProviderIndexPlugin,
  NatesclawProviderIndexProviderAuthChoice,
  NatesclawProviderIndexProvider,
} from "./types.js";
...
const NATESCLAW_PROVIDER_INDEX_VERSION = 1;
...
function normalizeInstall(value: unknown): NatesclawProviderIndexPluginInstall | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizePlugin(value: unknown): NatesclawProviderIndexPlugin | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
function normalizeOnboardingScopes(
  value: unknown,
): NatesclawProviderIndexProviderAuthChoice["onboardingScopes"] | undefined {
...
function normalizeAssistantVisibility(
  value: unknown,
): NatesclawProviderIndexProviderAuthChoice["assistantVisibility"] | undefined {
...
function normalizeAuthChoice(params: {
  ...
  providerName: string;
  value: unknown;
}): NatesclawProviderIndexProviderAuthChoice | undefined {
...
function normalizeAuthChoices(params: {
  ...
  providerName: string;
  value: unknown;
}): readonly NatesclawProviderIndexProviderAuthChoice[] | undefined {
  if (!Array.isArray(params.value)) {
    return undefined;
  }
  const choices = params.value
    .map((value) => normalizeAuthChoice({ ...params, value }))
    .filter((choice): choice is NatesclawProviderIndexProviderAuthChoice => Boolean(choice));
...
function normalizeProvider(
  ...
  value: unknown,
): NatesclawProviderIndexProvider | undefined {
  if (!isRecord(value)) {
    return undefined;
  }
...
export function normalizeNatesclawProviderIndex(value: unknown): NatesclawProviderIndex | undefined {
  if (!isRecord(value) || value.version !== NATESCLAW_PROVIDER_INDEX_VERSION) {
    return undefined;
  }
  if (!isRecord(value.providers)) {
    return undefined;
  }
  const providers: Record<string, NatesclawProviderIndexProvider> = {};
  ...
  return {
    version: NATESCLAW_PROVIDER_INDEX_VERSION,
