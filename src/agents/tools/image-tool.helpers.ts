...
export function coerceImageModelConfig(cfg?: NatesclawConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: NatesclawConfig; ref: string }): string[] {
