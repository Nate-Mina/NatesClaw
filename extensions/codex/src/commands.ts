 ...
 */
import type { NatesclawPluginCommandDefinition } from "natesclaw/plugin-sdk/plugin-entry";
...
export function createCodexCommand(options: CodexCommandOptions): NatesclawPluginCommandDefinition {
  return {
    name: "codex",
