...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__natesclaw" in message &&
    (message as { __natesclaw?: unknown })["__natesclaw"] &&
    typeof (message as { __natesclaw?: unknown })["__natesclaw"] === "object"
      ? ((message as { __natesclaw?: Record<string, unknown> })["__natesclaw"] ?? {})
      : undefined;
