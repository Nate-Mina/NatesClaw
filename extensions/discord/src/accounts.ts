...
import type { DiscordAccountConfig, DiscordActionConfig, NatesclawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: NatesclawConfig): ResolvedDiscordAccount[] {
