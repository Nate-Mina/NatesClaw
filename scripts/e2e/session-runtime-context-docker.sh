...
IMAGE_NAME="$(docker_e2e_resolve_image "natesclaw-session-runtime-context-e2e" NATESCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="natesclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t natesclaw-session-runtime-context-log.XXXXXX)"
