// Host Command script supports Natesclaw repository automation.
...
const HOST_COMMAND_CHILD_PID_PREFIX = "__NATESCLAW_HOST_COMMAND_CHILD_PID__";
const HOST_COMMAND_SPAWN_ERROR_PREFIX = "__NATESCLAW_HOST_COMMAND_SPAWN_ERROR__";
const HOST_COMMAND_TIMEOUT_PREFIX = "__NATESCLAW_HOST_COMMAND_TIMEOUT__";
