...
vi.mock("natesclaw/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("natesclaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("natesclaw/plugin-sdk/command-auth-native", () => ({
...
vi.mock("natesclaw/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("natesclaw/plugin-sdk/reply-history", () => ({
...
vi.mock("natesclaw/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("natesclaw/plugin-sdk/channel-pairing");
    vi.doUnmock("natesclaw/plugin-sdk/command-auth-native");
    vi.doUnmock("natesclaw/plugin-sdk/runtime-group-policy");
    vi.doUnmock("natesclaw/plugin-sdk/runtime-env");
    vi.doUnmock("natesclaw/plugin-sdk/reply-history");
    vi.doUnmock("natesclaw/plugin-sdk/routing");
