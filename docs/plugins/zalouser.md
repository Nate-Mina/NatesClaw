...
read_when:
  - You want Zalo Personal (unofficial) support in Natesclaw
  - You are configuring or developing the zalouser plugin
title: "Zalo personal plugin"
---

Zalo Personal support for Natesclaw via a plugin that uses native `zca-js` to
...
natesclaw channels login --channel zalouser --account <name>
...
natesclaw directory groups list --channel zalouser --query "name"
