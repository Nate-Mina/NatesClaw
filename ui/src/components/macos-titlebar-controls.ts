...
class MacosTitlebarControls extends NatesclawLightDomContentsElement {
  ...
  private renderButton(options: {
    ...
    return html`
      <natesclaw-tooltip .content=${options.tooltip ?? options.label}>
        <button
          type="button"
...
if (!customElements.get("natesclaw-macos-titlebar-controls")) {
  customElements.define("natesclaw-macos-titlebar-controls", MacosTitlebarControls);
}
