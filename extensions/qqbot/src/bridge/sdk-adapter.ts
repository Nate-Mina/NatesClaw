...
import { parseAccessGroupAllowFromEntry } from "natesclaw/plugin-sdk/access-groups";
import {
  createChannelIngressResolver,
  defineStableChannelIngressIdentity,
} from "natesclaw/plugin-sdk/channel-ingress-runtime";
import { resolveInboundMentionDecision } from "natesclaw/plugin-sdk/channel-mention-gating";
  ...
  return {
    async resolveInboundAccess(input) {
      ...
      const resolved = await createChannelIngressResolver({
        ...
        cfg: input.cfg as NatesclawConfig,
      }).message({
