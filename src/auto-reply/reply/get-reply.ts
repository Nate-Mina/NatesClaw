...
import { type NatesclawConfig, getRuntimeConfig } from "../../config/config.js";
...
function resolveHeartbeatAckMaxChars(_cfg: NatesclawConfig, _agentId: string): number {
...
function hasExplicitAudioUnderstandingConfig(cfg: NatesclawConfig): boolean {
