...
type AgentDefaultsModel = NonNullable<NonNullable<NatesclawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<NatesclawConfig["agents"]>["defaults"]>["models"];
