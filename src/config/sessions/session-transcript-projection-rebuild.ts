...
> & {
  session_transcript_active_events: NatesclawAgentKyselyDatabase["session_transcript_active_events"] & {
    rowid: Generated<number>;
  };
  session_transcript_fts: NatesclawAgentKyselyDatabase["session_transcript_fts"] & {
    rowid: Generated<number>;
  };
};
