...
enum class NatesclawCapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class NatesclawCanvasCommand(
  val rawValue: String,
) {
...
enum class NatesclawCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class NatesclawCameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class NatesclawSmsCommand(
  val rawValue: String,
) {
  Send("sms.send"),
  Search("sms.search"),
...
enum class NatesclawTalkCommand(
  val rawValue: String,
) {
...
enum class NatesclawLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class NatesclawDeviceCommand(
  val rawValue: String,
) {
...
enum class NatesclawNotificationsCommand(
  val rawValue: String,
) {
...
enum class NatesclawSystemCommand(
  val rawValue: String,
) {
...
enum class NatesclawPhotosCommand(
  val rawValue: String,
) {
...
enum class NatesclawContactsCommand(
  val rawValue: String,
) {
...
enum class NatesclawCalendarCommand(
  val rawValue: String,
) {
...
enum class NatesclawMotionCommand(
  val rawValue: String,
) {
...
enum class NatesclawCallLogCommand(
  val rawValue: String,
) {
...
enum class NatesclawMobileUiCommand(
  val rawValue: String,
) {
