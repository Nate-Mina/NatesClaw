...
// without touching ~/.natesclaw/natesclaw.json.
const getRuntimeConfigMock = vi.fn();
const mutateConfigFileMock = vi.fn();

vi.mock("natesclaw/plugin-sdk/runtime-config-snapshot", () => ({
...
afterAll(() => {
  vi.doUnmock("natesclaw/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("natesclaw/plugin-sdk/config-mutation");
  vi.resetModules();
});
