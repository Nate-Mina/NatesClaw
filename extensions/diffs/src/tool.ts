...
import { optionalFiniteNumberSchema, stringEnum } from "natesclaw/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, NatesclawPluginApi, NatesclawPluginToolContext } from "../api.js";
