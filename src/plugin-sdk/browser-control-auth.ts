// Browser control auth helpers resolve plugin browser credentials from Natesclaw config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: NatesclawConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;
