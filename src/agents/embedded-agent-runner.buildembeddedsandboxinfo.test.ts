...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/natesclaw-sandbox",
    agentWorkspaceDir: "/tmp/natesclaw-workspace",
    workspaceAccess: "none",
    runtimeId: "natesclaw-sbx-test",
    runtimeLabel: "natesclaw-sbx-test",
    containerName: "natesclaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "natesclaw-sbx-browser-test",
    },
