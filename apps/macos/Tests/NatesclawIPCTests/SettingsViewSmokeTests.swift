...
struct SettingsViewSmokeTests {
    ...
    @Test func `Natesclaw settings require configured inference`() {
    ...
    @Test func `Natesclaw preserves same route and resets for gateway changes`() {
        let stateDir = URL(fileURLWithPath: "/Users/tester/.natesclaw")
