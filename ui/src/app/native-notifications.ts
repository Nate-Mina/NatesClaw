...
type NativeNotificationsWindow = Window & {
  ...
  webkit?: {
    messageHandlers?: {
      natesclawNotifications?: WebKitNotificationsMessageHandler;
    };
  };
};
...
export function createNativeNotificationsCapability(): NativeNotificationsCapability | null {
  ...
  let snapshot = snapshotFrom(nativeWindow["__NATESCLAW_NATIVE_NOTIFICATIONS__"]) ?? {
