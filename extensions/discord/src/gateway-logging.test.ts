...
let logVerbose: typeof import("natesclaw/plugin-sdk/runtime-env").logVerbose;
...
describe("attachDiscordGatewayLogging", () => {
  beforeAll(async () => {
    const { logVerbose: loadedLogVerbose } = await import("natesclaw/plugin-sdk/runtime-env");
