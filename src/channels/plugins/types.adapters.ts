...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: NatesclawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: NatesclawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: NatesclawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: NatesclawConfig;
    accountId: string;
    enabled: boolean;
  }) => NatesclawConfig;
  deleteAccount?: (params: { cfg: NatesclawConfig; accountId: string }) => NatesclawConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: NatesclawConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NatesclawConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NatesclawConfig) => boolean | Promise<boolean>
  >;
  ...
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: NatesclawConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: NatesclawConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: NatesclawConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: NatesclawConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.natesclaw.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: NatesclawConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: NatesclawConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: NatesclawConfig;
    nextCfg: NatesclawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: NatesclawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: NatesclawConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: NatesclawConfig; accountId?: string | null }) =>
    | {
