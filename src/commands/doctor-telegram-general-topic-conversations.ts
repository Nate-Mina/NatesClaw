...
function resolveRepairScopes(cfg: NatesclawConfig, env: NodeJS.ProcessEnv) {
...
function repairLegacyRow(database: NatesclawAgentDatabase, legacyConversationId: string): boolean {
