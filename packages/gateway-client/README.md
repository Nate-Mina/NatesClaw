...
Package versions follow the Natesclaw calendar release train: `YYYY.M.PATCH`,
including the Natesclaw prerelease suffix when applicable. The package version is
