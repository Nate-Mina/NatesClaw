 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("natesclaw.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").NatesclawConfig;
 ...
 */
export function registerSlashCommandRoute(api: NatesclawPluginApi) {
