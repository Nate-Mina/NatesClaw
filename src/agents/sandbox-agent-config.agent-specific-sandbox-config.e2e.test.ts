...
async function resolveContext(config: NatesclawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): NatesclawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
