...
const BUNDLED_EXTENSION_CONFIG_IMPORT_GUARDS = [
  {
    ...
    allowedSpecifier: "natesclaw/plugin-sdk/channel-config-schema",
    forbiddenSpecifier: "natesclaw/plugin-sdk/bundled-channel-config-schema",
  },
  {
  ...
  },
  {
    ...
    forbiddenSpecifier: "natesclaw/plugin-sdk/channel-config-schema",
  },
  {
