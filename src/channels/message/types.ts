...
export type ChannelMessageSendTextContext<TConfig = NatesclawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = NatesclawConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = NatesclawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = NatesclawConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = NatesclawConfig> =
...
type ChannelMessageSendFailureContext<TConfig = NatesclawConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = NatesclawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;
...
export type ChannelMessageDeferredDeliveryAdmissionContext<TConfig = NatesclawConfig> = {
  cfg: TConfig;
  channel: string;
  to: string;
  accountId?: string | null;
