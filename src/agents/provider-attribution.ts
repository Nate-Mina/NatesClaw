...
const NATESCLAW_ATTRIBUTION_PRODUCT = "Natesclaw";
const NATESCLAW_ATTRIBUTION_ORIGINATOR = "natesclaw";
...
function formatNatesclawUserAgent(version: string): string {
  return `${NATESCLAW_ATTRIBUTION_ORIGINATOR}/${version}`;
}
...
function resolveProviderAttributionIdentity(
  ...
  return {
    product: NATESCLAW_ATTRIBUTION_PRODUCT,
...
function buildNvidiaAttributionPolicy(
  ...
  return {
    ...
    headers: {
      "X-BILLING-INVOKE-ORIGIN": NATESCLAW_ATTRIBUTION_PRODUCT,
    },
  };
}
...
function buildGoogleAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      "x-goog-api-client": `${NATESCLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: NATESCLAW_ATTRIBUTION_ORIGINATOR,
      version: identity.version,
      "User-Agent": formatNatesclawUserAgent(identity.version),
    },
  };
}
