...
function getChannelConfig(cfg: NatesclawConfig): ChannelConfig {
...
function resolveLegacyAccount(cfg: NatesclawConfig): AccountConfig {
  const channel = getChannelConfig(cfg);
  return {
    ...channel,
...
function setLegacyAccount(cfg: NatesclawConfig, patch: AccountConfig): NatesclawConfig {
  const channel = getChannelConfig(cfg);
  if (!channel.accounts) {
    return {
      ...cfg,
