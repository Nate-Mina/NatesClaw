...
internal const val actionOpenConversationNotification =
  "ai.natesclaw.app.action.OPEN_CONVERSATION_NOTIFICATION"
internal const val actionConsumeConversationNotification =
  "ai.natesclaw.app.action.CONSUME_CONVERSATION_NOTIFICATION"
internal const val actionReplyConversationNotification =
  "ai.natesclaw.app.action.REPLY_CONVERSATION_NOTIFICATION"

private const val extraGatewayStableId = "ai.natesclaw.app.extra.CONVERSATION_GATEWAY_ID"
private const val extraAgentId = "ai.natesclaw.app.extra.CONVERSATION_AGENT_ID"
private const val extraSessionKey = "ai.natesclaw.app.extra.CONVERSATION_SESSION_KEY"
private const val extraRunId = "ai.natesclaw.app.extra.CONVERSATION_RUN_ID"
private const val extraLaunchToken = "ai.natesclaw.app.extra.CONVERSATION_LAUNCH_TOKEN"
private const val remoteInputReply = "ai.natesclaw.app.remote_input.CONVERSATION_REPLY"
private const val notificationIntentScheme = "natesclaw"
...
private const val conversationChannelId = "natesclaw.chat.replies"
private const val conversationNotificationId = 1
private const val conversationNotificationTagPrefix = "natesclaw.chat."
private const val conversationShortcutPrefix = "natesclaw-chat-"
private const val conversationGroup = "natesclaw.chat"
...
internal class ConversationReplyNotifier(
  ...
  private fun replyAction(target: ConversationNotificationTarget): NotificationCompat.Action {
    ...
    val remoteInput =
      RemoteInput
        ...
        .setLabel(nativeString("Reply to Natesclaw…"))
        .build()
  ...
  private fun ensureConversationShortcut(target: ConversationNotificationTarget) {
    val shortcut =
      ShortcutInfoCompat
        ...
        .setShortLabel(nativeString("Natesclaw"))
        .setLongLived(true)
  ...
  private fun assistantPerson(): Person =
    Person
      .Builder()
      .setName(nativeString("Natesclaw"))
      .setBot(true)
      .build()
