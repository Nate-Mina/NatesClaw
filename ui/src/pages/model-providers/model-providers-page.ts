...
export class ModelProvidersPage extends NatesclawLightDomElement {
...
if (!customElements.get("natesclaw-model-providers-page")) {
  customElements.define("natesclaw-model-providers-page", ModelProvidersPage);
}
