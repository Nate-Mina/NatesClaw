...
function collectExecSafeBinScopes(cfg: NatesclawConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: NatesclawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: NatesclawConfig): {
