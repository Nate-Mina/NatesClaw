...
- For Natesclaw docs work, choose a page type from `references/natesclaw.md` before drafting.
- Keep task-critical Natesclaw configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For Natesclaw docs work, apply the validation checklist in `references/natesclaw.md`.
