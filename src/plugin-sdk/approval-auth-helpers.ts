...
import type { NatesclawConfig } from "./config-runtime.js";
...
const IMPLICIT_SAME_CHAT_APPROVAL_AUTHORIZATION = Symbol(
  "natesclaw.implicitSameChatApprovalAuthorization",
);
...
export function createResolvedApproverActionAuthAdapter(params: {
  ...
  resolveApprovers: (params: { cfg: NatesclawConfig; accountId?: string | null }) => string[];
