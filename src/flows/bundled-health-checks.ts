...
import { asOptionalObjectRecord as readRecord } from "@natesclaw/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: NatesclawConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: NatesclawConfig; cwd?: string }): boolean {
