...
export class PluginPage extends NatesclawLightDomContentsElement {
...
if (!customElements.get("natesclaw-plugin-page")) {
  customElements.define("natesclaw-plugin-page", PluginPage);
}
