...
import { isTruthyEnvValue, isWSL2Sync } from "natesclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "natesclaw/plugin-sdk/string-coerce-runtime";

const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "NATESCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "NATESCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "NATESCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable NATESCLAW_TELEGRAM_DNS_RESULT_ORDER
