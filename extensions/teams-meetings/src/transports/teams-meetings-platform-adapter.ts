...
>({
  ...
  session: {
    ...
    participantIdentity: (transport) =>
      transport === "chrome-node"
        ...
        : "Microsoft Teams guest in the Natesclaw Chrome profile",
  },
  ...
  browser: {
    ...
    browserControlUnavailable: () => ({
      ...
      message:
        "Open the Natesclaw browser profile, finish the Teams sign-in, admission, or permission prompt, then retry.",
    }),
