...
import { resolveConfiguredCapabilityProvider } from "natesclaw/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "natesclaw/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: NatesclawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as NatesclawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as NatesclawConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as NatesclawConfig | null) ?? undefined,
