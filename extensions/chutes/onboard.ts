...
const chutesPresetAppliers = createModelCatalogPresetAppliers({
  ...
  resolveParams: (_cfg: NatesclawConfig) => ({
    providerId: "chutes",
...
export function applyChutesProviderConfig(cfg: NatesclawConfig): NatesclawConfig {
  return chutesPresetAppliers.applyProviderConfig(cfg);
}

export function applyChutesConfig(cfg: NatesclawConfig): NatesclawConfig {
...
export function applyChutesApiKeyConfig(cfg: NatesclawConfig): NatesclawConfig {
