...
vi.mock("natesclaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("natesclaw/plugin-sdk/media-understanding")>(
    "natesclaw/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("natesclaw/plugin-sdk/media-understanding");
  vi.resetModules();
});
