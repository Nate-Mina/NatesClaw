...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof NatesclawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: NatesclawConfig; env: NodeJS.ProcessEnv }): {
  cfg: NatesclawConfig;
  changes: string[];
} {
