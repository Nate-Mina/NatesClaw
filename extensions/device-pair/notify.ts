...
import type { NatesclawPluginService } from "natesclaw/plugin-sdk/core";
import { listDevicePairing } from "natesclaw/plugin-sdk/device-bootstrap";
...
function openNotifySubscriberStore(api: NatesclawPluginApi): NotifySubscriberStore {
...
async function notifyPendingPairingRequests(params: { api: NatesclawPluginApi }): Promise<void> {
...
async function runNotifyPoll(api: NatesclawPluginApi): Promise<void> {
...
export function createPairingNotifierService(api: NatesclawPluginApi): NatesclawPluginService {
