...
import ai.natesclaw.app.ui.NatesclawTheme
...
class AccessibilityDevActivity : AppCompatActivity() {
  ...
  private fun refreshForegroundPackage() {
    foregroundPackageName = NatesclawAccessibilityService.instance?.foregroundPackageName()
  }
...
private fun AccessibilityDevScreen(
  ...
  val serviceConnection by NatesclawAccessibilityService.connection.collectAsState()
