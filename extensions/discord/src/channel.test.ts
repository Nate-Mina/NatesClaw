...
function createCfg(): NatesclawConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: NatesclawConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: NatesclawConfig, accountId = "default") {
