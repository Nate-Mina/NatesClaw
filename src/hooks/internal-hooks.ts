/**
 * Hook system for Natesclaw agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("natesclaw.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("natesclaw.internalHooksEnabled");
