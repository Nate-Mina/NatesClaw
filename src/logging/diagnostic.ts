...
function resolveDiagnosticSessionStorePaths(config?: NatesclawConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
 ...
 */
export function isStuckSessionRecoveryEnabled(config?: NatesclawConfig): boolean {
