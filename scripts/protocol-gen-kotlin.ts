// Protocol Gen Kotlin script supports Natesclaw repository automation.
...
const gatewayOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/natesclaw/app/gateway/GatewayProtocol.kt",
);
const constantsOutputPath = path.join(
  repoRoot,
  "apps/android/app/src/main/java/ai/natesclaw/app/protocol/NatesclawProtocolConstants.kt",
);
...
const androidEnums: EnumSpec[] = [
  ...
  enumSpec("NatesclawCanvasCommand", "canvas.", [
    ["Present", "present"],
    ["Hide", "hide"],
    ["Navigate", "navigate"],
    ["Eval", "eval"],
  ...
  enumSpec("NatesclawCanvasA2UICommand", "canvas.a2ui.", [
    ["Push", "push"],
    ["PushJSONL", "pushJSONL"],
    ["Reset", "reset"],
  ]),
  enumSpec("NatesclawCameraCommand", "camera.", [
    ["List", "list"],
    ["Snap", "snap"],
    ["Clip", "clip"],
  ]),
  enumSpec("NatesclawSmsCommand", "sms.", [
    ["Send", "send"],
    ["Search", "search"],
  ]),
  enumSpec("NatesclawTalkCommand", "talk.", [
    ["PttStart", "ptt.start"],
    ["PttStop", "ptt.stop"],
    ["PttCancel", "ptt.cancel"],
    ["PttOnce", "ptt.once"],
  ]),
  enumSpec("NatesclawLocationCommand", "location.", [["Get", "get"]]),
  enumSpec("NatesclawDeviceCommand", "device.", [
    ["Status", "status"],
    ["Info", "info"],
  ...
  enumSpec("NatesclawNotificationsCommand", "notifications.", [
    ["List", "list"],
    ["Actions", "actions"],
  ]),
  enumSpec("NatesclawSystemCommand", "system.", [["Notify", "notify"]]),
  enumSpec("NatesclawPhotosCommand", "photos.", [["Latest", "latest"]]),
  enumSpec("NatesclawContactsCommand", "contacts.", [
    ["Search", "search"],
    ["Add", "add"],
  ]),
  enumSpec("NatesclawCalendarCommand", "calendar.", [
    ["Events", "events"],
    ["Add", "add"],
  ]),
  enumSpec("NatesclawMotionCommand", "motion.", [
    ["Activity", "activity"],
    ["Pedometer", "pedometer"],
  ]),
  enumSpec("NatesclawCallLogCommand", "callLog.", [["Search", "search"]]),
  enumSpec("NatesclawMobileUiCommand", "mobile.ui.", [
    ["Observe", "observe"],
    ["Act", "act"],
  ]),
];
