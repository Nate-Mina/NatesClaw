...
function collectToolAllowlistSources(cfg: NatesclawConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: NatesclawConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: NatesclawConfig): string[] {
