...
vi.mock("./runtime.js", async () => {
  const replyChunking = await import("natesclaw/plugin-sdk/reply-chunking");
  const textChunking = await import("natesclaw/plugin-sdk/text-chunking");
  const markdownTables = await import("natesclaw/plugin-sdk/markdown-table-runtime");
  const runtime = {
    channel: {
      text: {
