...
struct LicenseDocumentLoaderTests {
    ...
    @Test func `derives readable titles from license filenames`() {
        ...
        #expect(LicenseDocumentLoader.title(from: "natesclaw_plugin_sdk.txt") == "natesclaw plugin sdk")
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("NatesclawLicenseDocumentLoaderTests-\(UUID().uuidString)", isDirectory: true)
