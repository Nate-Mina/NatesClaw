...
import { movePathToTrash as movePathToTrashWithAllowedRoots } from "natesclaw/plugin-sdk/browser-config";
...
export async function movePathToTrash(targetPath: string): Promise<string> {
  return await movePathToTrashWithAllowedRoots(targetPath, {
    // Managed browser data follows NATESCLAW_STATE_DIR/NATESCLAW_CONFIG_PATH, which
