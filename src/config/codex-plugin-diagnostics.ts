...
function codexPluginEntryEnabled(cfg: NatesclawConfig): boolean | undefined {
...
function resolveEffectiveSelectedModelRefs(params: { cfg: NatesclawConfig; agentId: string }): {
  complete: boolean;
