---
name: natesclaw-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm Natesclaw GHSA security advisories and private-fork state."
---

# Natesclaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-natesclaw-maintainer`.
...
```bash
fork=$(gh api /repos/natesclaw/natesclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/natesclaw/natesclaw/security-advisories/<GHSA> \
