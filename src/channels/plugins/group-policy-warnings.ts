...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: NatesclawConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: NatesclawConfig }>(
  collector: WarningCollector<{ cfg: NatesclawConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: NatesclawConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: NatesclawConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: NatesclawConfig },
>(
  projectCfg: (cfg: NatesclawConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: NatesclawConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: NatesclawConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: NatesclawConfig },
>(params: {
  providerConfigPresent: (cfg: NatesclawConfig) => boolean;
