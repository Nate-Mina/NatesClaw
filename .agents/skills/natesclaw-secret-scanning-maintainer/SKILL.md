...
Use this skill when processing alerts from `https://github.com/openclaw/natesclaw/security/secret-scanning`.
...
[
  {
    ...
    "location_url": "https://github.com/openclaw/natesclaw/issues/63101#issuecomment-xxx",
