...
/**
 * Universal Natesclaw talk animation: Compose port of the shared Siri-style
 * waveform in `apps/shared/NatesclawKit/Sources/NatesclawChatUI/TalkWaveformView.swift`.
