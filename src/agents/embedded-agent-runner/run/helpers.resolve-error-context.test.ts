...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded Natesclaw harness provider when the model provider is known", () => {
    // The Natesclaw harness id is a transport wrapper, not the provider users
