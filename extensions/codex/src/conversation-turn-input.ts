...
import type { PluginHookInboundClaimEvent } from "natesclaw/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "natesclaw/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // Natesclaw channels expose either local staged files or remote URLs. Keep
