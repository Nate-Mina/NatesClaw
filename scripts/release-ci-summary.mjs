...
const DEFAULT_REPO = process.env.NATESCLAW_RELEASE_REPO || "natesclaw/natesclaw";
const RELEASE_EVIDENCE_SCHEMA = "natesclaw.release-validation-evidence/v3";
...
function downloadParentManifestEvidence(runId, runAttempt, repository, manifestPath) {
  ...
  const downloadDir = mkdtempSync(join(tmpdir(), "natesclaw-release-ci-summary-"));
  try {
