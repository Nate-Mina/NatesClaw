...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  ...streamingAliasMigration.legacyConfigRules,
  {
    ...
    message:
      'Signal transport config is now account-owned; run "natesclaw doctor --fix" to migrate retired channels.signal transport fields.',
    match: (value) =>
      isRecord(value) &&
  ...
  },
  {
    ...
    message:
      'Signal transport config is now account-owned; run "natesclaw doctor --fix" to migrate retired per-account transport fields.',
