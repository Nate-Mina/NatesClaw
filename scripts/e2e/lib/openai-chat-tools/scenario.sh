...
MODEL_REF="${NATESCLAW_OPENAI_CHAT_TOOLS_MODEL:?missing NATESCLAW_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/natesclaw-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/natesclaw-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" NATESCLAW_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \
