...
internal class WearReplyNotifier(
  ...
  fun show(inbound: WearInboundEvent) {
    ...
    val agent = Person.Builder().setName("Natesclaw").build()
    val notification =
      NotificationCompat
  ...
  private companion object {
    const val CHANNEL_ID = "natesclaw_wear_replies"
  }
}
...
internal const val EXTRA_SESSION_KEY = "natesclaw_wear_session_key"
internal const val EXTRA_NOTIFICATION_TAG = "natesclaw_wear_notification_tag"
internal const val EXTRA_PHONE_NODE_ID = "natesclaw_wear_phone_node_id"
...
internal fun replyNotificationTag(
  ...
  return "ai.natesclaw.wear.NOTIFICATION.${sha256("$sessionKey\u0000$messageIdentity")}"
}

internal fun replyPendingIntentAction(
  sessionKey: String,
  notificationTag: String,
): String = "ai.natesclaw.wear.REPLY.${sha256("$sessionKey\u0000$notificationTag")}"
...
private const val LOG_TAG = "NatesclawWear"
