...
import type { NatesclawStateDatabaseOptions } from "./natesclaw-state-db-contract.js";
import { ensureAgentDatabaseLeaseSchema } from "./natesclaw-state-db-schema-additive.js";
...
export function claimNatesclawAgentDatabaseLease(params: {
  agentId: string;
  path: string;
...
export function releaseNatesclawAgentDatabaseLease(
  leaseId: string,
...
export function assertNoNatesclawAgentDatabaseLeases(
  agentIdRaw: string,
  options: NatesclawStateDatabaseOptions = {},
): void {
