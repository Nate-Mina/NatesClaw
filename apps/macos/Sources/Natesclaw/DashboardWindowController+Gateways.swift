...
extension DashboardWindowController {
    static let gatewaysMessageHandlerName = "natesclawGateways"
        ...
        dispatch: Bool) -> String
    {
        ...
        let event = dispatch
            ...
            "{detail:window.__NATESCLAW_NATIVE_GATEWAYS__}));"
            : ""
        return "window.__NATESCLAW_NATIVE_GATEWAYS__=\(json);\(event)"
    }
