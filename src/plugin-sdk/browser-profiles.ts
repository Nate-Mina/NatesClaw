...
export const DEFAULT_NATESCLAW_BROWSER_ENABLED = true;
...
export const DEFAULT_NATESCLAW_BROWSER_COLOR = "#FF4500";
/** Default Natesclaw-managed browser profile name. */
export const DEFAULT_NATESCLAW_BROWSER_PROFILE_NAME = "natesclaw";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "natesclaw";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredNatesclawTmpDir(), "uploads");
