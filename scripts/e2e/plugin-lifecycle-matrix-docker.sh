...
IMAGE_NAME="$(docker_e2e_resolve_image "natesclaw-plugin-lifecycle-matrix-e2e" NATESCLAW_PLUGIN_LIFECYCLE_MATRIX_E2E_IMAGE)"
SKIP_BUILD="${NATESCLAW_PLUGIN_LIFECYCLE_MATRIX_E2E_SKIP_BUILD:-0}"
cleanup() {
...
PACKAGE_TGZ="$(docker_e2e_prepare_package_tgz plugin-lifecycle-matrix "${NATESCLAW_CURRENT_PACKAGE_TGZ:-}")"
