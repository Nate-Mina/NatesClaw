...
const LAUNCHER_ENCODING_MARKER_PREFIX = "@rem natesclaw-launcher-encoding=";
const LAUNCHER_ENCODING_MARKER_RE = /^@rem natesclaw-launcher-encoding=(\S+)\s*$/;
...
/** Decodes launcher scripts written by any Natesclaw version (UTF-16 LE BOM, marked code page, or UTF-8). */
