 ...
 *
 * Runs after Natesclaw resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common Natesclaw auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and Natesclaw wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before Natesclaw builds its generic
 ...
 */
/** Provider-facing effort after Natesclaw lowers orchestration-only modes. */
