...
import type { NatesclawSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("natesclaw-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: NatesclawSkillMetadata;
}): SkillEntry {
