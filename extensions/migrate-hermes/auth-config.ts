...
import { resolveMigrationConfigRuntime } from "natesclaw/plugin-sdk/migration";
import type { MigrationProviderContext } from "natesclaw/plugin-sdk/plugin-entry";
import { applyAuthProfileConfig, type NatesclawConfig } from "natesclaw/plugin-sdk/provider-auth";
...
export async function applyAuthProfileConfigWithConflictCheck(params: {
  ctx: MigrationProviderContext;
  profile: HermesAuthProfileConfig;
  applyConfigPatch?: (config: NatesclawConfig) => NatesclawConfig;
