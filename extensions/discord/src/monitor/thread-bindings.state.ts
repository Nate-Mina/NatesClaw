...
import { recordOutboundMessageIdentity } from "natesclaw/plugin-sdk/outbound-echo-runtime";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "natesclaw/plugin-sdk/routing";
import {
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("natesclaw.discordThreadBindingsState");
