...
class GatewayUrlConfirmation extends NatesclawLightDomContentsElement {
...
if (!customElements.get("natesclaw-gateway-url-confirmation")) {
  customElements.define("natesclaw-gateway-url-confirmation", GatewayUrlConfirmation);
}
