...
function resolveSessionKey(params: { cfg: NatesclawConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: NatesclawConfig): string[] {
