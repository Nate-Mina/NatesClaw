...
type BuildCommandTextFromArgs =
  typeof import("natesclaw/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("natesclaw/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("natesclaw/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("natesclaw/plugin-sdk/command-auth-native").parseCommandArgs;
