---
summary: "How to contribute to the Natesclaw threat model"
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Natesclaw security hall of fame for significant contributions.
