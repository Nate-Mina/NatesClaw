...
/// panel keeps using `NatesclawChatView` directly; this shell is the full
/// window experience.
@MainActor
public struct NatesclawChatWindowShell: View {
    public nonisolated static let assistantTraceDefaultsKey = "natesclaw.webchat.showAssistantTrace"
    public nonisolated static let assistantReasoningDefaultsKey = "natesclaw.webchat.showAssistantReasoning"
    public nonisolated static let assistantToolActivityDefaultsKey = "natesclaw.webchat.showAssistantToolActivity"
    ...
    private let displayOptions: NatesclawChatDisplayOptions
    private let emptyAssistantIntro: String?
    private let emptyAssistantPrompts: [NatesclawChatView.StarterPrompt]
    private let talkControl: NatesclawChatTalkControl?
    private let voiceNoteControl: NatesclawChatVoiceNoteControl?
    ...
    public init(
        ...
        displayOptions: NatesclawChatDisplayOptions? = nil,
        showsAssistantTrace: Bool = false,
        emptyAssistantIntro: String? = nil,
        emptyAssistantPrompts: [NatesclawChatView.StarterPrompt] = [],
        talkControl: NatesclawChatTalkControl? = nil,
        voiceNoteControl: NatesclawChatVoiceNoteControl? = nil,
        speech: NatesclawChatSpeechController? = nil,
    ...
    private var activeSessionEntry: NatesclawChatSessionEntry? {
...
private struct ChatContextUsageMenu: View {
    let usage: NatesclawChatContextUsage
    let onCompact: () -> Void

    var body: some View {
        Menu {
            Text(self.tokensLine)
                .font(NatesclawChatTypography.body(size: 13, weight: .regular, relativeTo: .body))
