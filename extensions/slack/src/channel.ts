...
import { adaptScopedAccountAccessor } from "natesclaw/plugin-sdk/channel-config-helpers";
import {
...
import { buildOutboundBaseSessionKey, type RoutePeer } from "natesclaw/plugin-sdk/routing";
...
//
// `natesclaw/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "natesclaw/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "natesclaw/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as NatesclawConfig, toolContext as SlackActionContext | undefined),
    }),
