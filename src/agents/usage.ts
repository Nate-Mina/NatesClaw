 ...
 * Converts provider-specific usage shapes into Natesclaw's normalized input,
...
/** Normalize provider-specific token usage fields into Natesclaw usage buckets. */
 ...
 * recombine Natesclaw's separately priced buckets and retain their details.
