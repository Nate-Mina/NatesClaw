...
`natesclaw worker` is the restricted runtime entry point for a cloud worker
...
The gateway installs the matching Natesclaw bundle and opens the host-key-pinned
