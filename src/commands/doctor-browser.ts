...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: NatesclawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: NatesclawConfig, deps?: BrowserDoctorDeps) {
  try {
