...
describe("Natesclaw provider index", () => {
  ...
  it("loads the bundled provider index without runtime plugin loading", () => {
    const index = loadNatesclawProviderIndex();
