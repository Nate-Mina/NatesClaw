...
import {
  NatesclawLightDomContentsElement,
  NatesclawLightDomElement,
  NatesclawLitElement,
} from "./natesclaw-element.ts";

const LIGHT_ELEMENT_NAME = "test-natesclaw-light-dom-element";
const LIGHT_CONTENTS_ELEMENT_NAME = "test-natesclaw-light-dom-contents-element";
const SHADOW_ELEMENT_NAME = "test-natesclaw-shadow-dom-element";

class TestLightDomElement extends NatesclawLightDomElement {
  renderCount = 0;
...
class TestShadowDomElement extends NatesclawLitElement {
  override render() {
    return html`<span>shadow content</span>`;
  }
}

class TestLightDomContentsElement extends NatesclawLightDomContentsElement {
  override render() {
...
describe("Natesclaw Lit elements", () => {
  beforeEach(async () => {
