...
type CreateNatesclawToolsOpts = Parameters<CreateSessionsSpawnTool>[0];
...
export async function getSessionsSpawnTool(opts: CreateNatesclawToolsOpts) {
...
vi.mock("../config/sessions.js", () => ({
  ...
  resolveSessionStorePathCore: () => "/tmp/natesclaw-sessions-spawn-test-store.json",
