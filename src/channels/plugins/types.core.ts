...
export type ChannelAgentToolFactory = (params: { cfg?: NatesclawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NatesclawConfig; accountId?: string | null }) => string[];
  messageToolCapabilities?: (params: {
    cfg: NatesclawConfig;
    accountId?: string | null;
  }) => string[] | undefined;
  inboundFormattingHints?: (params: { cfg: NatesclawConfig; accountId?: string | null }) =>
    | {
        text_markup: string;
        rules: string[];
      }
