...
final class MacNodeCodexThreadCatalogClient: @unchecked Sendable {
    ...
    init(
        ...
        loadRoot: @escaping () -> [String: Any] = { NatesclawConfigFile.loadDict() })
    {
...
final class CodexAppServerThreadClient: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "ai.natesclaw.codex-thread-catalog")
    ...
    private static func initializeRequestData(id: Int) throws -> Data {
        try self.jsonData([
            ...
            "params": [
                "clientInfo": [
                    "name": "natesclaw_macos",
                    "title": "Natesclaw macOS Node",
