// Nostr plugin entrypoint registers its Natesclaw integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "natesclaw/plugin-sdk/channel-entry-contract";
import type { NatesclawConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as NatesclawConfig;
