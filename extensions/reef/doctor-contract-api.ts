...
import type { ChannelDoctorLegacyConfigRule } from "natesclaw/plugin-sdk/channel-contract";
...
function configuredReefIdentityBinding(cfg: NatesclawConfig): ConfiguredReefIdentityBinding {
...
function inspectLegacyReefFriends(cfg: NatesclawConfig) {
  const reef = cfg.channels?.reef;
...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  {
    path: ["channels", "reef"],
    message:
      'channels.reef dmPolicy/allowFrom are legacy; run "natesclaw doctor --fix" to remove them. Peer trust is SQLite-backed.',
