...
export const GATEWAY_WS_CONNECTION_KIND_PROPERTY = "__natesclawConnectionKind";
export const GATEWAY_WS_PREAUTH_BUDGET_PROPERTY = "__natesclawPreauthBudget";
...
export type GatewayIngressWebSocket = WebSocket & {
  ...
  __natesclawPreauthBudgetClaimed?: boolean;
  __natesclawPreauthBudgetKey?: string;
};
