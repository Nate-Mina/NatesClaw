...
function hasPotentialPluginConfig(config: NatesclawConfig, env: NodeJS.ProcessEnv): boolean {
...
function collectConfiguredMemoryEmbeddingProviderIds(config: NatesclawConfig): ReadonlySet<string> {
...
function hasConfiguredCapabilityPlugin(config: NatesclawConfig, env: NodeJS.ProcessEnv): boolean {
