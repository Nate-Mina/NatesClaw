import { isTranscriptOnlyNatesclawAssistantMessage } from "../../../shared/transcript-only-natesclaw-assistant.js";
...
const SESSIONS_YIELD_INTERRUPT_CUSTOM_TYPE = "natesclaw.sessions_yield_interrupt";
const SESSIONS_YIELD_CONTEXT_CUSTOM_TYPE = "natesclaw.sessions_yield";
  ...
  activeSession.sessionManager.removeTrailingEntries(
    ...
    },
    {
      preserveTrailing: (entry) =>
        ...
        (entry.type === "message" && isTranscriptOnlyNatesclawAssistantMessage(entry.message)),
    },
  );
}
