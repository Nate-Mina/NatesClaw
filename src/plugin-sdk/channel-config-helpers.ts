...
type ChannelConfigAccessorParams<Config extends NatesclawConfig = NatesclawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends NatesclawConfig = NatesclawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends NatesclawConfig = NatesclawConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: NatesclawConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends NatesclawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends NatesclawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends NatesclawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
