...
import { resolveDangerousNameMatchingEnabled } from "natesclaw/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full Natesclaw config object. */
function getChannelConfig(cfg: NatesclawConfig): SynologyChatChannelConfig | undefined {
...
export function resolveAccount(
  ...
  const envBotName = normalizeOptionalString(process.env.NATESCLAW_BOT_NAME) ?? "Natesclaw";
