...
enum class GatewayMethod(
  ...
  NatesclawChat("natesclaw.chat"),
  NatesclawChatHistory("natesclaw.chat.history"),
  NatesclawChangesList("natesclaw.changes.list"),
  NatesclawApprovalList("natesclaw.approval.list"),
  NatesclawSetupDetect("natesclaw.setup.detect"),
  NatesclawSetupActivate("natesclaw.setup.activate"),
  NatesclawSetupAuthStart("natesclaw.setup.auth.start"),
  NatesclawSetupPrepareStart("natesclaw.setup.prepare.start"),
  ...
  NatesclawSetupVerify("natesclaw.setup.verify"),
...
enum class GatewayEvent(
  ...
  NatesclawApprovalRequested("natesclaw.approval.requested"),
  NatesclawApprovalResolved("natesclaw.approval.resolved"),
