...
function getPackageDir(): string {
  ...
  const envDir = process.env.NATESCLAW_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json natesclawConfig)
// =============================================================================
...
const NatesclawConfigName: string | undefined = pkg.natesclawConfig?.name;
export const APP_NAME: string = NatesclawConfigName || "natesclaw";
export const CONFIG_DIR_NAME: string = pkg.natesclawConfig?.configDir || ".natesclaw";
...
// =============================================================================
// User Config Paths (~/.natesclaw/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.natesclaw/agent/) */
