// Feishu plugin entrypoint registers its Natesclaw integration.
import {
...
function registerFeishuDocTools(api: NatesclawPluginApi) {
...
function registerFeishuChatTools(api: NatesclawPluginApi) {
  const register = loadBundledEntryExportSync<(api: NatesclawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: NatesclawPluginApi) {
  const register = loadBundledEntryExportSync<(api: NatesclawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: NatesclawPluginApi) {
  const register = loadBundledEntryExportSync<(api: NatesclawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: NatesclawPluginApi) {
  const register = loadBundledEntryExportSync<(api: NatesclawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: NatesclawPluginApi) {
  const register = loadBundledEntryExportSync<(api: NatesclawPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
