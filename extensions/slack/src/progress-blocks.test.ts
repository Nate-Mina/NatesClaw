import { formatChannelProgressDraftText } from "natesclaw/plugin-sdk/channel-outbound";
      ...
      lines: [
        {
          ...
          icon: "🛠️",
          label: "Exec",
          detail: "run tests in /Users/example/Projects/natesclaw/packages/very/deep/path/example",
          text: "🛠️ Exec: run tests in /Users/example/Projects/natesclaw/packages/very/deep/path/example",
        },
      ],
    });
