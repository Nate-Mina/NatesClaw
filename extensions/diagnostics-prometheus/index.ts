// Diagnostics Prometheus plugin entrypoint registers its Natesclaw integration.
...
export default definePluginEntry({
  ...
  description: "Expose Natesclaw diagnostics metrics in Prometheus text format",
  register(api) {
