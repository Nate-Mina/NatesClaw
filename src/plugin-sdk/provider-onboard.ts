...
export type { NatesclawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: NatesclawConfig, ...args: TArgs) => NatesclawConfig;
  applyConfig: (cfg: NatesclawConfig, ...args: TArgs) => NatesclawConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: NatesclawConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: NatesclawConfig, preset: TParams) => NatesclawConfig;
  primaryModelRef: string;
...
export function createAliasOnlyPresetAppliers(params: {
  ...
  const applyProviderConfig = (cfg: NatesclawConfig): NatesclawConfig => {
...
export function applyOpencodeZenModelDefault(cfg: NatesclawConfig): {
