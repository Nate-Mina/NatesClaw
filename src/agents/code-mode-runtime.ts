...
function readCodeModeRawConfig(config?: NatesclawConfig, agentId?: string): Record<string, unknown> {
...
export function resolveCodeModeConfig(config?: NatesclawConfig, agentId?: string): CodeModeConfig {
