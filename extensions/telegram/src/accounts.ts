...
} from "natesclaw/plugin-sdk/account-core";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "natesclaw/plugin-sdk/config-contracts";
import { formatSetExplicitDefaultInstruction } from "natesclaw/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.NATESCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: NatesclawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: NatesclawConfig): string {
...
export function listEnabledTelegramAccounts(cfg: NatesclawConfig): ResolvedTelegramAccount[] {
