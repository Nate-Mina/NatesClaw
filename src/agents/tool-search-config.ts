...
function readToolSearchConfig(config?: NatesclawConfig): Record<string, unknown> {
...
export function resolveToolSearchConfig(config?: NatesclawConfig): ToolSearchConfig {
