...
`natesclaw/plugin-sdk/channel-outbound`. Use
`natesclaw/plugin-sdk/channel-inbound` for receive/context/dispatch
orchestration.
...
`natesclaw/plugin-sdk/error-runtime`. Core can then clear stale send-attempt
