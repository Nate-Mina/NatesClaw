...
import { createChannelApprovalNativeRuntimeAdapter } from "natesclaw/plugin-sdk/approval-handler-runtime";
...
import { buildPluginApprovalResolvedReplyPayload } from "natesclaw/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
import { normalizeUniqueStringEntries } from "natesclaw/plugin-sdk/string-coerce-runtime";
import {
...
// Natesclaw Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.natesclaw.approval" as const;
