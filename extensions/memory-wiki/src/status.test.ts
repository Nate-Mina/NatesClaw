...
import type { MemoryPluginPublicArtifact } from "natesclaw/plugin-sdk/memory-host-core";
...
describe("memory wiki doctor", () => {
  it("builds actionable fixes from status warnings", async () => {
    ...
    expect(rendered).toContain("natesclaw wiki init");
  });
