...
import { resolveAgentMaxConcurrent } from "natesclaw/plugin-sdk/model-session-runtime";
...
function createTelegramRunnerOptions(cfg: NatesclawConfig): RunOptions<unknown> {
  return {
    sink: {
