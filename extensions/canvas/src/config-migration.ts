...
import { asOptionalRecord as readRecord } from "natesclaw/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: NatesclawConfig): {
  ...
  const next = { ...config, plugins } as NatesclawConfig & { canvasHost?: unknown };
