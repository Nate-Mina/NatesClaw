...
const TELEGRAM_POLLING_LEASES_KEY = Symbol.for("natesclaw.telegram.pollingLeases");
const TELEGRAM_POLLING_SESSION_STATE_KEY = Symbol.for("natesclaw.telegram.pollingSessionState");
const TELEGRAM_REPLY_FENCE_STATE_KEY = Symbol.for("natesclaw.telegram.replyFenceState");
const TELEGRAM_SENT_MESSAGES_STATE_KEY = Symbol.for("natesclaw.telegramSentMessagesState");
const TELEGRAM_TOPIC_NAME_CACHE_STATE_KEY = Symbol.for("natesclaw.telegramTopicNameCacheState");
