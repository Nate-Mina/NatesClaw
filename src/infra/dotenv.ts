...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "OPENAI_API_KEYS",
  "NATESCLAW_AGENT_DIR",
  "NATESCLAW_ALLOW_PLUGIN_INSTALL_OVERRIDES",
  "NATESCLAW_ALLOW_INSECURE_PRIVATE_WS",
  "NATESCLAW_ALLOW_PROJECT_LOCAL_BIN",
  "NATESCLAW_BROWSER_EXECUTABLE_PATH",
  "NATESCLAW_BROWSER_CONTROL_MODULE",
  "NATESCLAW_BUNDLED_HOOKS_DIR",
  "NATESCLAW_BUNDLED_PLUGINS_DIR",
  "NATESCLAW_BUNDLED_SKILLS_DIR",
  ...
  "NATESCLAW_MPM_CATALOG_PATHS",
  "NATESCLAW_NODE_EXEC_FALLBACK",
  "NATESCLAW_NODE_EXEC_HOST",
  "NATESCLAW_OAUTH_DIR",
  "NATESCLAW_PINNED_PYTHON",
  "NATESCLAW_PINNED_WRITE_PYTHON",
  "NATESCLAW_PLUGIN_INSTALL_OVERRIDES",
  "NATESCLAW_PLUGIN_CATALOG_PATHS",
  "NATESCLAW_PROFILE",
  "NATESCLAW_RAW_STREAM",
  "NATESCLAW_RAW_STREAM_PATH",
  "NATESCLAW_SHOW_SECRETS",
  "NATESCLAW_SKIP_BROWSER_CONTROL_SERVER",
  "NATESCLAW_STATE_DIR",
  "NATESCLAW_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "AWS_ENDPOINT_URL_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full Natesclaw runtime namespace
  // for shell/global config so new NATESCLAW_* controls are fail-closed by default.
  "NATESCLAW_",
  "NATESCLAW_DISABLE_",
  "NATESCLAW_SKIP_",
  "NATESCLAW_UPDATE_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.natesclaw/.env (or NATESCLAW_STATE_DIR/.env),
