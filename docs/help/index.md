...
- [Doctor](/gateway/doctor) - `natesclaw doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where Natesclaw loads env vars and precedence
...
- [Natesclaw lore](/start/lore) - the story
