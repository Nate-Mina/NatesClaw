...
export function registerPluginsCli(program: Command) {
  const plugins = program
    .command("plugins")
    .description("Manage Natesclaw plugins and extensions")
    .addHelpText(
      "after",
      () =>
  ...
  marketplace
    .command("entries")
    .description("List entries from the configured Natesclaw marketplace feed")
  ...
  marketplace
    .command("refresh")
    .description("Refresh the configured Natesclaw marketplace feed snapshot")
