...
const STRUCTURED_AUTH_MARKER_PREFIX = ";__natesclaw_structured_auth_redacted_";

// Minimal fallback for standalone or unwired ACP core. Natesclaw injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Natesclaw-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@natesclaw/normalization-core/error-coercion";
