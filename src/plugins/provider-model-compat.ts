...
import { resolveUnsupportedToolSchemaKeywords } from "@natesclaw/ai/internal/openai";
import { resolveOpenAICompletionsCompat } from "@natesclaw/ai/transports";
...
// Tool-schema compat predicates moved into @natesclaw/ai (agent-tools-parameter-schema);
