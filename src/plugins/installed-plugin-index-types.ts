...
import type { NatesclawPackageBuild, PluginPackageChannel } from "./manifest.js";
...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by Natesclaw from plugin manifests, install records, and config policy. Use `natesclaw plugins registry --refresh`, `natesclaw plugins install/update/uninstall`, or `natesclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored natesclaw.install metadata. This describes catalog/package
