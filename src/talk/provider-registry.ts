...
function resolveRealtimeVoiceProviderEntries(cfg?: NatesclawConfig): RealtimeVoiceProviderPlugin[] {
...
function buildProviderMaps(cfg?: NatesclawConfig): {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: NatesclawConfig): RealtimeVoiceProviderPlugin[] {
