...
const DIAGNOSTIC_EVENTS_STATE_KEY = Symbol.for("natesclaw.diagnosticEvents.state.v1");
...
export function isDiagnosticsEnabled(config?: NatesclawConfig): boolean {
...
/** Emits an untrusted event whose trace context came from Natesclaw-owned scope. */
