...
const resolverPath = path.resolve("scripts/secrets/natesclaw-bws-resolver.mjs");

describe("natesclaw-bws-resolver", () => {
  it("forwards the self-hosted server URL without inheriting unrelated variables", () => {
    const dir = tempDirs.make("natesclaw-bws-resolver-");
