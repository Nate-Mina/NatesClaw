...
function resolveGoogleChatAccountImpl(params: { cfg: NatesclawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: NatesclawConfig) => {
...
function createGoogleChatCfg(): NatesclawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,
