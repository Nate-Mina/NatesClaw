...
`precise.yml` is Natesclaw's shipped precise OpenGrep rulepack. Each rule is tied
...
Some Natesclaw paths are excluded by `.gitignore` for build reasons even though
