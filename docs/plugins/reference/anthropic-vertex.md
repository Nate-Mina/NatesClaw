---
summary: "Natesclaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
Natesclaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI.
...
`/think off` or the native `/think xhigh|max` levels. Natesclaw publishes its
