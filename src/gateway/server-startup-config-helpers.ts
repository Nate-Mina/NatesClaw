...
export function hasActiveGatewayAuthSecretRef(config: NatesclawConfig): boolean {
...
export function assertRuntimeGatewayAuthNotKnownWeak(config: NatesclawConfig): void {
