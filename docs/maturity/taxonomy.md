...
summary: "Detailed reference for the product areas and checks behind the Natesclaw maturity scorecard."
---
...
<Tabs>
  <Tab title="Core">
    ...
    <a className="maturity-surface-link" href="#natesclaw-app-sdk">
      <span className="maturity-surface-title">Natesclaw App SDK</span>
...
<AccordionGroup>
  ...
  <Accordion title="Natesclaw App SDK - M2 Alpha - 6 areas">
    <a id="natesclaw-app-sdk" />

    Natesclaw App SDK is a distinct external app contract separate from Gateway runtime and Plugin SDK. Current scoring shows a real `@natesclaw/sdk` path with gaps around public packaging, auto-discovery, approvals, helpers, and compatibility.
    ...
    [Natesclaw Sdk](/gateway/external-apps), [Natesclaw Sdk Api Design](/gateway/external-apps)
    ...
    [Natesclaw Sdk](/gateway/external-apps), [Natesclaw Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol), [Index](/gateway/security/index)
    ...
    [Natesclaw Sdk](/gateway/external-apps), [Natesclaw Sdk Api Design](/gateway/external-apps), [Protocol](/gateway/protocol)
    ...
    [Natesclaw Sdk Api Design](/gateway/external-apps), [Typebox](/concepts/typebox), [Protocol](/gateway/protocol)
...
<AccordionGroup>
  ...
  <Accordion title="Linux companion app - M0 Planned - 5 areas">
    ...
    [Linux](/platforms/linux), [Natesclaw](/start/natesclaw), [Doctor](/gateway/doctor)
