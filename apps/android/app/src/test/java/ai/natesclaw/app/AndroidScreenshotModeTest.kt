...
class AndroidScreenshotModeTest {
  ...
  @Test
  fun NatesclawSceneTargetsSystemAgentSettings() {
    val scene = AndroidScreenshotScene.fromRawValue("natesclaw")

    assertEquals(AndroidScreenshotScene.Natesclaw, scene)
