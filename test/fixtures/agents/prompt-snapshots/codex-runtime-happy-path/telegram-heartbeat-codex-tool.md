...
```json
{
  ...
  "simulatedHeartbeatWorkspaceFile": "/tmp/natesclaw-happy-path/workspace/HEARTBEAT.md",
  "simulatedWorkspaceBootstrapFiles": ["/tmp/natesclaw-happy-path/workspace/MEMORY.md"],
  "simulatedWorkspaceTurnScopedDeveloperInstructionFiles": [
    "/tmp/natesclaw-happy-path/workspace/IDENTITY.md",
    "/tmp/natesclaw-happy-path/workspace/SOUL.md",
    "/tmp/natesclaw-happy-path/workspace/USER.md"
  ],
...
```json
{
  ...
  "config": {
    "code_mode.direct_only_tool_namespaces": ["natesclaw_direct"],
  ...
  "cwd": "/tmp/natesclaw-happy-path/workspace",
...
```json
{
  ...
  "NatesclawRuntime": {
    ...
    "workspaceBootstrapContextFrom": "extensions/codex app-server turn/start input Natesclaw runtime context"
  }
}
```
...
Deferred searchable Natesclaw dynamic tools available: automations, gateway, nodes, session_status, sessions_history, sessions_list, sessions_search, sessions_send, subagents, tts, web_fetch, web_search.
...
Use Codex native `spawn_agent` for Codex subagents. `spawn_agent` and the other native collaboration tools may be deferred. Use Natesclaw `sessions_spawn` only for Natesclaw or ACP delegation, never as a substitute for `spawn_agent`.
...
## /tmp/natesclaw-happy-path/workspace/MEMORY.md
