...
function hasProviderWildcardModelAllowlist(cfg: NatesclawConfig) {
  const modelMaps = [
...
function resolveConfiguredReplaceModeCatalog(cfg: NatesclawConfig) {
...
function shouldLoadFullGatewayCatalogForReplaceMode(cfg: NatesclawConfig) {
...
async function loadEmbeddedTuiModelCatalog(cfg: NatesclawConfig) {
