...
import { readFiniteNumberParam } from "natesclaw/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- natesclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- natesclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- natesclaw:human:start -->";
const HUMAN_END = "<!-- natesclaw:human:end -->";
