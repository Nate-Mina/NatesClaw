...
final class ExecApprovalsGatewayPrompter {
    ...
    private let logger = Logger(subsystem: "ai.natesclaw", category: "exec-approvals.gateway")
    ...
    private func handle(push: GatewayPush) async {
        ...
        guard evt.event == "exec.approval.requested" || evt.event == "natesclaw.approval.requested" else { return }
        ...
        do {
            ...
            if evt.event == "natesclaw.approval.requested" {
