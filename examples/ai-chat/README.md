# @natesclaw/ai example: minimal chat completion

Smallest possible consumer of the published `@natesclaw/ai` package: creates an
isolated runtime, registers the built-in API providers, and streams one
completion. No Natesclaw application code is involved — inside this repo the
