...
import type { DiscordActionConfig } from "natesclaw/plugin-sdk/config-contracts";
...
function discordAllowlistCfg(guilds: Record<string, unknown>): NatesclawConfig {
  return {
    channels: {
      discord: {
        token: "token",
...
function handleMessagingAction(
  ...
  cfg: NatesclawConfig = DISCORD_TEST_CFG,
  options?: {
    mediaAccess?: {
