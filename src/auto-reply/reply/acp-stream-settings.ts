...
import type { AcpSessionUpdateTag } from "@natesclaw/acp-core/runtime/types";
...
export function resolveAcpProjectionSettings(cfg: NatesclawConfig): AcpProjectionSettings {
