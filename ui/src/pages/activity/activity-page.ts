...
class ActivityPage extends NatesclawLightDomElement {
...
if (!customElements.get("natesclaw-activity-page")) {
  customElements.define("natesclaw-activity-page", ActivityPage);
}
