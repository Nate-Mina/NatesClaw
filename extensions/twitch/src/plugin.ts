...
} from "natesclaw/plugin-sdk/channel-pairing";
 ...
 * for Natesclaw. Supports message sending, receiving, access control, and
 * status monitoring.
 */
    ...
    base: {
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("natesclaw/plugin-sdk/runtime-env").RuntimeEnv;
