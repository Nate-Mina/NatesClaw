...
type HeartbeatOutcomeTable = NatesclawAgentKyselyDatabase["heartbeat_outcomes"];
type HeartbeatOutcomeDatabase = Pick<NatesclawAgentKyselyDatabase, "heartbeat_outcomes">;
