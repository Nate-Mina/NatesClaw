...
export function appendClawHubRiskAcknowledgementGuidance(params: {
  ...
  return `${params.message} To review and acknowledge this ClawHub package, run \`natesclaw plugins install ${shellSpec} --acknowledge-clawhub-risk\` from a trusted shell, then rerun repair.`;
}
