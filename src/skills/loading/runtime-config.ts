...
function hasConfiguredSkillApiKeyRef(config?: NatesclawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: NatesclawConfig): NatesclawConfig | undefined {
