/**
 * Natesclaw plugin tool resolver.
 *
...
import {
  resolveNatesclawPluginToolInputs,
  type NatesclawPluginToolOptions,
} from "./natesclaw-tools.plugin-context.js";
...
type ResolveNatesclawPluginToolsOptions = NatesclawPluginToolOptions & {
...
export function resolveNatesclawPluginToolsForOptions(params: {
  options?: ResolveNatesclawPluginToolsOptions;
  ...
  const pluginToolInputs = resolveNatesclawPluginToolInputs({
