...
- Repo: `natesclaw/discrawl`; use `~/GIT/_Perso/discrawl` only after verifying
  its remote targets `natesclaw/discrawl`, otherwise use a fresh checkout
...
`natesclaw/discrawl` checkout before concluding the feature is missing.
