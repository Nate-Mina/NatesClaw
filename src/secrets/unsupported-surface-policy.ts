...
// Candidate scanning only sees natesclaw.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an natesclaw.json-like object.
 */
...
/**
 * Finds configured natesclaw.json values whose surfaces currently reject SecretRef objects.
 */
