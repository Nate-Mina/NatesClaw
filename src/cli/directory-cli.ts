    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["natesclaw directory self --channel slack", "Show the connected account identity."],
          [
            'natesclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["natesclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "natesclaw directory groups members --channel discord --group-id <id>",
