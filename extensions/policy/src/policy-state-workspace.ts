...
export function scanPolicyAgentWorkspace(
  ...
  pushAgentWorkspaceEvidence(entries, {
    ...
    tools: defaultTools,
    inheritedTools: {},
    workspaceSourceBase: "oc://natesclaw.config/agents/defaults",
    inheritedWorkspaceSourceBase: "oc://natesclaw.config/agents/defaults",
    toolsSourceBase: "oc://natesclaw.config/tools",
    inheritedToolsSourceBase: "oc://natesclaw.config/tools",
  });
  ...
  list.forEach((agent, index) => {
    ...
    pushAgentWorkspaceEvidence(entries, {
      ...
      workspaceSourceBase: `oc://natesclaw.config/agents/list/#${index}`,
      inheritedWorkspaceSourceBase: "oc://natesclaw.config/agents/defaults",
      toolsSourceBase: `oc://natesclaw.config/agents/list/#${index}/tools`,
      inheritedToolsSourceBase: "oc://natesclaw.config/tools",
    });
  });
  ...
  const sandboxModeSource =
    explicitSandboxMode !== undefined
      ...
      : inheritedSandboxMode !== undefined
        ...
        : "oc://natesclaw.config/agents/defaults/sandbox/mode";
    ...
    source:
      explicitWorkspaceAccess !== undefined
        ...
        : inheritedWorkspaceAccess !== undefined
          ...
          : "oc://natesclaw.config/agents/defaults/sandbox/workspaceAccess",
    scope: params.scope,
