...
type FeishuReadContext = FeishuActionReadContext | NatesclawPluginToolContext;
...
function resolveFeishuReadGroupPolicy(cfg: NatesclawConfig, account: ResolvedFeishuAccount) {
