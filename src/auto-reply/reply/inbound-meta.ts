...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "natesclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by Natesclaw out-of-band. Treat it as authoritative metadata about the current message context.",
