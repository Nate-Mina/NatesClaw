/**
 * Reads Natesclaw session history for Codex transcript mirroring and sanitizes
...
import type { SessionEntry } from "natesclaw/plugin-sdk/agent-sessions";
import {
  buildSessionContext,
  migrateSessionEntries,
  parseSessionEntries,
} from "natesclaw/plugin-sdk/agent-sessions";
import { readCodexSessionTranscriptEventsBeforeAdmission } from "natesclaw/plugin-sdk/codex-session-transcript-runtime";
import {
  getSessionEntry,
