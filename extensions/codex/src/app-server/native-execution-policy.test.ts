...
import type { getSessionEntry as getSessionEntryType } from "natesclaw/plugin-sdk/session-store-runtime";
...
vi.mock("natesclaw/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("natesclaw/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,
