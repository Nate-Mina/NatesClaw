...
describe("codex conversation turn input", () => {
  ...
  it("uses staged remote-cache paths for remote iMessage image attachments", () => {
    ...
    const stagedPath = "/tmp/natesclaw-proof/.natesclaw/media/remote-cache/imessage/photo.jpg";
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaPath: "file:///tmp/Natesclaw%20QA/photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "/tmp/Natesclaw QA/photo.png" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrls: ["/tmp/staged-photo.png", "file:///tmp/Natesclaw%20QA/second.jpg"],
      ...
      { type: "localImage", path: "/tmp/Natesclaw QA/second.jpg" },
    ]);
  });
    ...
    expect(
      buildCodexConversationTurnInput({
        ...
        event: {
          ...
          isGroup: false,
          metadata: {
            mediaUrl: "C:\\Natesclaw QA\\photo.png",
            mediaType: "image/png",
          },
        },
      }),
      ...
      { type: "text", text: "look", text_elements: [] },
      { type: "localImage", path: "C:\\Natesclaw QA\\photo.png" },
    ]);
  });
});
