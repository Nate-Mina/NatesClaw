...
export type TtsRuntimeFacade = {
  ...
  buildTtsSystemPromptHint: (cfg: NatesclawConfig, agentId?: string) => string | undefined;
  ...
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: NatesclawConfig) => TtsProvider[];
