...
import { createReplyToFanout } from "natesclaw/plugin-sdk/channel-outbound";
import {
  attachChannelToResult,
  createAttachedChannelResultAdapter,
} from "natesclaw/plugin-sdk/channel-send-result";
import type { MessagePresentationBlock } from "natesclaw/plugin-sdk/interactive-runtime";
import {
...
import { statRegularFileSync } from "natesclaw/plugin-sdk/security-runtime";
import {
  isRecord,
...
const RENDERED_FEISHU_CARD = Symbol("natesclaw.renderedFeishuCard");
const FEISHU_PRESENTATION_FALLBACK_MARKER = "__natesclawPresentationFallback";
