...
metadata: { "natesclaw": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- Natesclaw CLI path: `node --inspect-brk natesclaw.mjs ...`
- Natesclaw test path: `NATESCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
