...
import { normalizeOptionalString as normalizeString } from "natesclaw/plugin-sdk/string-coerce-runtime";
...
function isFeishuConfigured(cfg: NatesclawConfig): boolean {
