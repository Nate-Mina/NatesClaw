...
import type { AuthProfileStore, NatesclawConfig } from "natesclaw/plugin-sdk/provider-auth";
...
function resolveFalConfiguredBaseUrl(cfg?: NatesclawConfig): string | undefined {
