---
summary: "Natesclaw is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing Natesclaw to newcomers
title: "Natesclaw"
---
...
<p align="center">
    <img
        src="/assets/natesclaw-hero-light.png"
        alt="Natesclaw"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/natesclaw-hero-dark.png"
        alt="Natesclaw"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install Natesclaw and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="list-checks">
    Guided setup with `natesclaw onboard` and pairing flows.
  </Card>
...
Natesclaw is a **self-hosted gateway** that connects your favorite chat apps — Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more via channel plugins — to AI coding agents. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-natesclaw.jpg" alt="Natesclaw" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.natesclaw/natesclaw.json`.

- If you **do nothing**, Natesclaw uses the bundled Natesclaw agent runtime; DMs share the agent's main session, and each group chat gets its own session.
