import type { ControlUiSessionNamespace } from "@natesclaw/session-url-contract";
...
type SessionPathBuilder = typeof import("@natesclaw/session-url-contract").buildControlUiSessionPath;
