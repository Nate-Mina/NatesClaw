...
export const QA_LAB_WEB_SEARCH_DENIED_INPUT_QUERY = "NATESCLAW_QA_WEB_SEARCH_DENIED_INPUT";
...
export function createQaLabWebSearchProviderBase(): Omit<WebSearchProviderPlugin, "createTool"> {
  return {
    ...
    signupUrl: "https://docs.natesclaw.ai/concepts/qa-e2e-automation",
    docsUrl: "https://docs.natesclaw.ai/concepts/qa-e2e-automation",
    credentialPath: "",
    inactiveSecretPaths: [],
