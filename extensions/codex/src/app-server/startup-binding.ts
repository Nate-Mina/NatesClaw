...
import { root as openSafeFilesystemRoot } from "natesclaw/plugin-sdk/file-access-runtime";
...
// Codex owns proactive auto-compaction, but Natesclaw must not resume a native
