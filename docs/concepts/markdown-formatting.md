...
Natesclaw converts outbound Markdown into a shared intermediate representation
...
Natesclaw tells the model about this option only when the current reply surface
