---
name: natesclaw-refactor-docs
description: Refactor an existing Natesclaw docs page with source-audited preservation, restructuring, and verification.
---

# Natesclaw Refactor Docs

## Overview

Use this skill when the user gives a target Natesclaw docs page and asks to
