...
class SessionKeyTest {
  ...
  fun buildAndroidAppSessionLabelIncludesDeviceDisplayName() {
    assertEquals("Natesclaw App · 1234567890ab", buildAndroidAppSessionLabel(null, "1234567890abcdef"))
    assertEquals(
      "Natesclaw App · Pixel · 1234567890ab",
