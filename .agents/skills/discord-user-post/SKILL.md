...
description: Post an approved message as the logged-in Discord user through the Discord desktop app. Use for release announcements or other direct user-authored Discord posts; not for Natesclaw channel sends, bots, webhooks, relays, agent sessions, or archive search.
---
...
- Never use `natesclaw message`, an Natesclaw agent, a Discord bot, webhook, relay,
