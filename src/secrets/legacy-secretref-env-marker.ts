...
function toCandidate(
  ...
  defaults: NonNullable<NatesclawConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: NatesclawConfig): {
  config: NatesclawConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as NatesclawConfig & Record<string, unknown>;
