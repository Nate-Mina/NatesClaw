...
import { installNatesclawInternalCorePackageNativeResolver } from "../../../plugins/plugin-sdk-native-resolver.js";
import {
...
const VIRTUAL_MODULES: Record<string, unknown> = {
  ...
  "natesclaw/plugin-sdk/agent-core": bundledAgentCore,
  "@openclaw/plugin-sdk/agent-core": bundledAgentCore,
  "natesclaw/plugin-sdk/llm": bundledLlm,
  "@openclaw/plugin-sdk/llm": bundledLlm,
  "natesclaw/plugin-sdk/agent-sessions": bundledAgentSessions,
...
const EXTENSION_LOADER_ALIAS_IMPORT_PATTERN =
  /(?:@natesclaw\/plugin-sdk|natesclaw\/plugin-sdk|@sinclair\/typebox|typebox)(?:\/[A-Za-z0-9_-]+)?/u;
...
function getExtensionLoaderAliases(): Record<string, string> {
  ...
  aliases = {
    ...
    "natesclaw/plugin-sdk/agent-sessions": agentSessionsEntry,
...
async function loadExtensionSourceTransformModule(
  ...
  if (!context.sourceTransformLoader) {
    installNatesclawInternalCorePackageNativeResolver({ moduleUrl: import.meta.url });
