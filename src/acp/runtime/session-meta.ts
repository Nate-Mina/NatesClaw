...
type AcpSessionsTable = NatesclawStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<NatesclawStateKyselyDatabase, "acp_sessions">;
...
function selectAcpSessionRows(options: NatesclawStateDatabaseOptions = {}): AcpSessionRow[] {
