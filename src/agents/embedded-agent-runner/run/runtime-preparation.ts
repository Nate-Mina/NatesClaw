...
export async function prepareEmbeddedRunRuntime(input: {
  ...
  pluginHarnessOwnsTransport = agentHarness.id !== "natesclaw";
  ...
  const pluginHarnessNeedsNatesclawAuthBootstrap =
  ...
  if (!pluginHarnessOwnsTransport || pluginHarnessNeedsNatesclawAuthBootstrap) {
