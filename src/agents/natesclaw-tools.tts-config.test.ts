// Verifies createNatesclawTools wires shared config and context into the TTS tool.
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/natesclaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./natesclaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createNatesclawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createNatesclawTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createNatesclawTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createNatesclawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
