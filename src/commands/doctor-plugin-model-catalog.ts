...
/** Detects only marker-backed catalogs produced by tagged Natesclaw releases. */
...
export async function maybeMigrateLegacyPluginModelCatalogs(params: {
  ...
  emitNote(
    [
      ...
      "Run natesclaw doctor --fix to verify and migrate these catalogs into agent SQLite.",
    ].join("\n"),
