...
const EMPTY_CONFIG: NatesclawConfig = {};
const pricingContextByConfig = new WeakMap<NatesclawConfig, PricingContext>();
...
function buildPricingContext(config: NatesclawConfig): PricingContext {
...
function getPricingContext(config: NatesclawConfig): PricingContext {
...
export function modelCatalogPricingFingerprint(config?: NatesclawConfig): string {
