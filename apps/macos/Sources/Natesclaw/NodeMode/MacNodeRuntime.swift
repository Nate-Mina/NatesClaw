    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case NatesclawCameraCommand.snap.rawValue,
                 ...
                 NatesclawCameraCommand.ptzStatus.rawValue,
                 NatesclawCameraCommand.ptzControl.rawValue:
                return try await self.handleCameraInvoke(req)
            case NatesclawLocationCommand.get.rawValue:
            ...
            case NatesclawComputerCommand.act.rawValue:
                return try await self.handleComputerActInvoke(req)
            case NatesclawSystemCommand.notify.rawValue:
            ...
            let code: NatesclawNodeErrorCode = switch error {
...
extension MacNodeRuntime {
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case NatesclawCanvasA2UICommand.push.rawValue,
             NatesclawCanvasA2UICommand.pushJSONL.rawValue:
...
extension MacNodeRuntime {
    private func handleCameraInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case NatesclawCameraCommand.list.rawValue:
            ...
            return BridgeInvokeResponse(id: req.id, ok: true, payloadJSON: payload)
        case NatesclawCameraCommand.ptzStatus.rawValue:
            let params: NatesclawCameraPTZStatusParams
            do {
                params = try Self.decodeParams(NatesclawCameraPTZStatusParams.self, from: req.paramsJSON)
            } catch {
            ...
            return BridgeInvokeResponse(id: req.id, ok: true, payloadJSON: payload)
        case NatesclawCameraCommand.ptzControl.rawValue:
            let params: NatesclawCameraPTZControlParams
            do {
                params = try Self.decodeParams(NatesclawCameraPTZControlParams.self, from: req.paramsJSON)
            } catch {
    ...
    private func handleComputerActInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        let params: NatesclawComputerActParams
        do {
            params = try Self.decodeParams(NatesclawComputerActParams.self, from: req.paramsJSON)
        } catch {
            return Self.errorResponse(
                req,
                code: .invalidRequest,
        ...
        do {
            ...
            case .accessibilityNotTrusted:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "ACCESSIBILITY_REQUIRED: grant Accessibility permission to Natesclaw")
            ...
            case .postEventAccessDenied:
                return Self.errorResponse(
                    req,
                    code: .unavailable,
                    message: "POST_EVENT_REQUIRED: macOS denied Event Posting access; re-grant Natesclaw "
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> NatesclawLocationMode {
    ...
    private static func errorResponse(
        ...
        code: NatesclawNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: NatesclawNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: NatesclawCanvasSnapshotFormat,
        maxWidth: Int?,
