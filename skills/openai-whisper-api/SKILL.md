...
Set `OPENAI_API_KEY`, or configure it in the active Natesclaw config file (`$NATESCLAW_CONFIG_PATH`, default `~/.natesclaw/natesclaw.json`). Optionally set `OPENAI_BASE_URL`:
