...
type WorktreesTable = NatesclawStateKyselyDatabase["worktrees"];
type WorktreeRow = Selectable<WorktreesTable>;
type WorktreeRegistryDatabase = Pick<NatesclawStateKyselyDatabase, "worktrees">;
type WorktreeProvisionedDatabase = Pick<
  NatesclawStateKyselyDatabase,
  "worktree_provisioned_file_chunks"
>;
type WorktreeLeaseDatabase = Pick<NatesclawStateKyselyDatabase, "worktrees" | "state_leases">;
