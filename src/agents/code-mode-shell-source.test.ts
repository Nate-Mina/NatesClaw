...
describe("isShellLikeCodeModeSource", () => {
  ...
  it.each([
    ...
    'const result = await tools.callValue("natesclaw:core:exec", { command: "ls" }); return result;',
    'return await tools.callValue("natesclaw:core:read", { path: "/workspace" });',
    "console.log(await tools.callValue('natesclaw:core:read', { path: '/workspace' }));",
