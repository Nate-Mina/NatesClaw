...
import { NATESCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat.js";
...
describe("context engine runtime settings", () => {
  it("builds declared normal runtime settings from host and model inputs", () => {
    ...
    expect(settings).toMatchObject({
      ...
      executionHost: {
        id: NATESCLAW_EMBEDDED_CONTEXT_ENGINE_HOST.id,
        label: NATESCLAW_EMBEDDED_CONTEXT_ENGINE_HOST.label,
      },
      limits: {
        promptTokenBudget: 128_000,
        maxOutputTokens: 8192,
