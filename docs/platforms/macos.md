---
summary: "Install and use the Natesclaw macOS menu bar app"
read_when:
...
The macOS app is the Natesclaw **menu bar companion**: native tray UI, macOS
...
1. Install and launch **Natesclaw.app**.
...
5. Finish. The app opens the dashboard, where Natesclaw guides the rest of the
...
Natesclaw, and opens the dashboard. If the Gateway cannot connect or its
...
Both modes need an installed `natesclaw` CLI because the app reuses its node-host
