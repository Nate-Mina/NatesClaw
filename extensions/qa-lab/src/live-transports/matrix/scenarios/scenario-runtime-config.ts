...
import { isRecord as isMatrixQaPlainRecord } from "natesclaw/plugin-sdk/string-coerce-runtime";
import {
  buildMatrixQaToken,
  buildMentionPrompt,
...
export async function runMatrixQaAllowlistHotReloadScenario(
  ...
  const configPath = context.gatewayRuntimeEnv?.NATESCLAW_CONFIG_PATH;
