...
class CanvasNavigationPolicyTest {
  ...
  fun keepsRemoteEmulatorBridgeAndBundledUrls() {
    val accepted =
      listOf(
        ...
        "http://gateway.local:18789/__natesclaw__/canvas/",
        "http://10.0.2.2:18789/__natesclaw__/canvas/",
  ...
  fun controllerUsesSharedPolicyForDirectLoads() {
    ...
    controller.navigate("http://10.0.2.2:18789/__natesclaw__/canvas/")
    assertEquals("http://10.0.2.2:18789/__natesclaw__/canvas/", controller.currentUrl())
  }
