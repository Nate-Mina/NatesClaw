// Linux native-app admission tests: natesclaw-linux joins the native UI client class,
...
describe("linux native-app handshake admission", () => {
  it("auto-approves local natesclaw-linux pairing and keeps remote pairing explicit", () => {
