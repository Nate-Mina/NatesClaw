...
if [[ -z "$version_content" ]]; then
  echo "<h2>Natesclaw $VERSION</h2>"
  echo "<p>Latest Natesclaw update.</p>"
  echo "<p><a href=\"https://github.com/natesclaw/natesclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
