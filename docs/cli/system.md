---
summary: "CLI reference for `natesclaw system` (system events, heartbeat, presence)"
read_when:
...
natesclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$NATESCLAW_GATEWAY_TOKEN"
natesclaw system heartbeat enable
natesclaw system heartbeat last
natesclaw system presence
```
